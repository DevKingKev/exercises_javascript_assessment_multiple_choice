...
const metadata = {
    ...
    "topicLinks": [
        ...
        { "topicName": "Event delegation", "refLink": "https://developer.mozilla.org/en-US/docs/Learn/JavaScript/Building_blocks/Events#event_delegation" },
        { "topicName": "Shadow DOM and encapsulation", "refLink": "https://developer.mozilla.org/en-US/docs/Web/Web_Components/Using_shadow_DOM" },
        { "topicName": "Custom Elements", "refLink": "https://developer.mozilla.org/en-US/docs/Web/Web_Components/Using_custom_elements" },
        { "topicName": "Template and cloning", "refLink": "https://developer.mozilla.org/en-US/docs/Web/HTML/Element/template" },
        { "topicName": "Selectors API", "refLink": "https://developer.mozilla.org/en-US/docs/Web/API/Document/querySelector" },
        { "topicName": "MutationObserver", "refLink": "https://developer.mozilla.org/en-US/docs/Web/API/MutationObserver" },
        { "topicName": "Node and Element interfaces", "refLink": "https://developer.mozilla.org/en-US/docs/Web/API/Node" },
        { "topicName": "focus and accessibility", "refLink": "https://developer.mozilla.org/en-US/docs/Web/Accessibility" },
        { "topicName": "Element.getBoundingClientRect", "refLink": "https://developer.mozilla.org/en-US/docs/Web/API/Element/getBoundingClientRect" }
    ]
};
