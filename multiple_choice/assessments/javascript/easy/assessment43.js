module.exports = {
  ...
  "questions": [
    ...
    },
    {
      ...
      "options": {
        "A": "Testing only the oldest parts of the codebase",
        "B": "Testing that new changes don't break existing features",
    ...
    },
    {
      ...
      "options": {
        "A": "Call the function being tested",
        "B": "Set up test data and preconditions",
        "C": "Check the results",
    ...
    },
    {
      ...
      "options": {
        "A": "It reduces the number of meetings",
        "B": "It makes code reviews unnecessary",
        "C": "It eliminates the need for documentation",
        "D": "It helps prevent breaking code that others depend on"
      },
      "correct": "D",
