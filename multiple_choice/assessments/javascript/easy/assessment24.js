// assessment24.js - AUTO-GENERATED topics and assessmentId
const metadata = {
...
const questions = [
    ...
    },
    {
        ...
        "options": {
            "A": "Runs regardless of resolution or rejection",
            "B": "Only runs if the Promise resolves",
            "C": "Only runs if the Promise rejects",
    ...
    },
    {
        ...
        "options": {
            "A": "<pre>new Promise(resolve => setTimeout(resolve, 1000))</pre>",
            "B": "<pre>Promise.resolve(setTimeout(1000))</pre>",
    ...
    },
    {
        ...
        "options": {
            ...
            "D": "Return the callback directly"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "options": {
            "A": "Yes, by using multiple await statements",
            "B": "No, await only works with one Promise",
            "C": "Only with Promise.all()",
            "D": "Only in certain browsers"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "options": {
            "A": "Returns the first settled Promise (resolve or reject)",
    ...
    },
    {
        ...
        "options": {
            ...
            "B": "Use multiple await statements",
    ...
    },
    {
        ...
        "options": {
            "A": "It may cause an unhandled promise rejection warning",
            "B": "The program crashes immediately",
            "C": "The rejection is ignored",
            "D": "It becomes a resolved Promise"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "options": {
            "A": "More readable, synchronous-looking code",
