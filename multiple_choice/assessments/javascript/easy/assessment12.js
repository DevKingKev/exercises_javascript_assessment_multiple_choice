// assessment12.js - AUTO-GENERATED topics and assessmentId
const metadata = {
    ...
    "assessmentId": 12,
    "assessmentUniqueId": 1730726407000,
...
const questions = [
    {
        ...
        "options": {
            "A": "<pre>first = 1, second = 2</pre>",
            "B": "<pre>first = 1, second = 3</pre>",
            "C": "<pre>first = [1, 2], second = 3</pre>",
    ...
    },
    {
        ...
        "options": {
            "A": "An iterator of [index, value] pairs",
            "B": "The array values",
            "C": "The array indices",
            "D": "A new array"
        },
