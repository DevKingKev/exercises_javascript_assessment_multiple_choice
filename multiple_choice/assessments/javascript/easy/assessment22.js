// assessment22.js - AUTO-GENERATED topics and assessmentId
const metadata = {
...
const questions = [
    ...
    },
    {
        ...
        "options": {
            "A": "All instances see the change immediately",
            "B": "Only new instances see the change",
            "C": "Existing instances keep old values",
    ...
    },
    {
        ...
        "options": {
            "A": "The new object instance",
            "B": "<pre>undefined</pre>",
            "C": "The prototype object",
    ...
    },
    {
        ...
        "options": {
            "A": "To reference back to the constructor function",
    ...
    },
    {
        ...
        "options": {
            "A": "<pre>Object.prototype.methodName = function() {}</pre>",
    ...
    },
    {
        ...
        "options": {
            "A": "instance → Person.prototype → Object.prototype → null",
            "B": "instance → Person → Object.prototype → null",
    ...
    },
    {
        ...
        "options": {
            "A": "<pre>Object.create()</pre> sets prototype directly, <pre>new</pre> uses constructor",
            "B": "<pre>new</pre> is faster",
            "C": "<pre>Object.create()</pre> only works with functions",
    ...
    },
    {
        ...
        "options": {
            "A": "A new own property is created on the instance",
            "B": "The prototype property is updated",
    ...
    },
    {
        ...
        "options": {
            "A": "Use <pre>for...in</pre> loop",
            "B": "Use <pre>Object.keys()</pre>",
    ...
    },
    {
        ...
        "options": {
            "A": "To save memory by sharing methods",
    ...
    },
    {
        ...
        "options": {
            "A": "Use object literal syntax: <pre>{prop: value}</pre>",
