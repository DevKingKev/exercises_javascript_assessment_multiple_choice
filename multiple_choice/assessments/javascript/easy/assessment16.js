// assessment16.js - AUTO-GENERATED topics and assessmentId
const metadata = {
    ...
    "assessmentId": 16,
    "assessmentUniqueId": 1730726411000,
...
const questions = [
    ...
    },
    {
        ...
        "options": {
            "A": "There's no built-in method for all cases",
    ...
    },
    {
        ...
        "options": {
            "A": "<pre>Object.keys(obj).forEach(key => {})</pre>",
            "B": "<pre>for (const key in obj) {}</pre>",
