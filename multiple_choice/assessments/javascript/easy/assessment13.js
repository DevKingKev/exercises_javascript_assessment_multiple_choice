module.exports = {
  ...
  "questions": [
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>Array.sum(arr)</pre>",
        "B": "<pre>arr.sum()</pre>",
        "C": "<pre>arr.reduce((a, b) => a + b, 0)</pre>",
    ...
    },
    {
      ...
      "options": {
        ...
        "D": "<pre>Array.from(arguments)</pre>"
      },
      "correct": "A",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "<pre>arr.every(x => typeof x === 'number')</pre>",
