module.exports = {
  "metadata": {
    ...
    "assessmentId": 13,
    "assessmentUniqueId": 1762474587363,
  ...
  "questions": [
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>arr.isEmpty()</pre>",
        "B": "<pre>arr.length === 0</pre>",
        "C": "<pre>arr === []</pre>",
        "D": "<pre>!arr</pre>"
      },
      "correct": "B",
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>Object.toArray()</pre>",
        "B": "<pre>Array.toArray()</pre>",
        "C": "<pre>Array.from()</pre>",
        "D": "<pre>array()</pre>"
      },
      "correct": "C",
    ...
    },
    {
      ...
      "options": {
        "A": "An array with [3]",
        "B": "An array with [1, 2, 3]",
        "C": "An array with [0, 1, 2]",
        "D": "An array with 3 empty slots"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>arr.reduce().concat()</pre>",
        "B": "<pre>arr.filter().map()</pre>",
        "C": "<pre>[...new Set(arr)]</pre>",
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>Number('1,2,3')</pre>",
        "B": "<pre>Array.from('1,2,3')</pre>",
        "C": "<pre>'1,2,3'.toArray()</pre>",
        "D": "<pre>'1,2,3'.split(',').map(Number)</pre>"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>arr.map(x => x * 2).filter(x => x % 2 === 0)</pre>",
        "B": "<pre>arr.filter(x => x % 2 === 0).map(x => x * 2)</pre>",
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>Array.equals(arr1, arr2)</pre>",
        "B": "<pre>arr1 === arr2</pre>",
        "C": "<pre>arr1 == arr2</pre>",
        "D": "Compare lengths and each element"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>Array.isNumeric(arr)</pre>",
        "B": "<pre>arr.isNumeric()</pre>",
        "D": "<pre>arr.filter(Number).length === arr.length</pre>",
        "undefined": "<pre>arr.every(x => typeof x === 'number')</pre>"
      },
