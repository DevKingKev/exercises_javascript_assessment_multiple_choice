// assessment27.js - AUTO-GENERATED topics and assessmentId
const metadata = {
...
const questions = [
    ...
    },
    {
        ...
        "options": {
            "A": "A Promise that resolves to a string",
            "B": "The response as a string immediately",
            "C": "A JSON object",
    ...
    },
    {
        ...
        "options": {
            "A": "<pre>Content-Type: application/json</pre>",
    ...
    },
    {
        ...
        "options": {
            "A": "<pre>fetch(url, {method: 'PUT'})</pre>",
            "B": "<pre>fetch.put(url)</pre>",
            "C": "<pre>fetch(url, 'PUT')</pre>",
    ...
    },
    {
        ...
        "options": {
            "A": "<pre>const text = await response.text();</pre>",
            "B": "<pre>const text = response.text;</pre>",
            "C": "<pre>const text = await response.string();</pre>",
    ...
    },
    {
        ...
        "options": {
            "A": "A Response object wrapped in a Promise",
    ...
    },
    {
        ...
        "options": {
            "A": "Use the Authorization header",
            "B": "Add to the URL",
    ...
    },
    {
        ...
        "options": {
            "A": "Checking for HTTP errors before parsing",
            "B": "Parsing JSON automatically",
    ...
    },
    {
        ...
        "options": {
            "A": "Specify what response format you want",
            "B": "Accept the request",
            "C": "Set request format",
    ...
    },
    {
        ...
        "options": {
            "A": "Sends cookies with the request",
