// assessment25.js - AUTO-GENERATED topics and assessmentId
const metadata = {
...
const questions = [
    {
        ...
        "topic": {
            "topics": ["Async function behavior"]
        }
    },
    {
        "id": 2,
    ...
    },
    {
        ...
        "options": {
            "A": "It returns the value immediately",
    ...
    },
    {
        ...
        "options": {
            "A": "<pre>new Promise(resolve => setTimeout(resolve, delay))</pre>",
            "B": "<pre>Promise.delay(delay)</pre>",
            "C": "<pre>setTimeout(Promise.resolve, delay)</pre>",
    ...
    },
    {
        ...
        "options": {
            ...
            "B": "To handle only successful results",
    ...
    },
    {
        ...
        "options": {
            "A": "<pre>Promise.resolve(value)</pre>",
            "B": "<pre>new Promise(value)</pre>",
    ...
    },
    {
        ...
        "options": {
            "A": "It returns a Promise resolving to undefined",
    ...
    },
    {
        ...
        "options": {
            "A": "Throws the rejection reason as an error",
            "B": "Returns undefined",
            "C": "Silently ignores the error",
            "D": "Retries the Promise"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "options": {
            "A": "<pre>await Promise.all([op1, op2])</pre>",
            "B": "<pre>await op1; await op2;</pre>",
            "C": "<pre>op1 && op2</pre>",
            "D": "<pre>Promise.join(op1, op2)</pre>"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "options": {
            "A": "<pre>sync, promise, timeout</pre>",
            "B": "<pre>sync, timeout, promise</pre>",
    ...
    },
    {
        ...
        "options": {
            "A": "Returns the first settled Promise",
    ...
    },
    {
        ...
        "options": {
            "A": "It returns a Promise immediately",
            "B": "It throws an error",
    ...
    },
    {
        ...
        "options": {
            "A": "Readable, sequential-looking code",
            "B": "Better performance",
            "C": "Fewer lines of code",
            "D": "Works without Promises"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "options": {
            "A": "A Promise that resolves to 'done'",
            "B": "The string 'done'",
