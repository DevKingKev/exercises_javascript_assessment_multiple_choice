module.exports = {
  "metadata": {
    ...
    "assessmentId": 9,
    "assessmentUniqueId": 1762442186085,
  ...
  "questions": [
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>element.setText('new text')</pre>",
        "B": "<pre>element.innerHTML = 'new text'</pre>",
        "C": "<pre>element.value = 'new text'</pre>",
        "D": "<pre>element.textContent = 'new text'</pre>"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>innerHTML</pre> parses HTML, <pre>textContent</pre> doesn't",
        "B": "No difference",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Events repeating automatically",
        "C": "Multiple events firing at once",
        "D": "Events moving from child to parent"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "Both A and B",
        "D": "<pre>parent.insert(newElement, referenceElement)</pre>"
      },
      "correct": "C",
