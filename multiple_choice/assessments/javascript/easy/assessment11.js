module.exports = {
  "metadata": {
    ...
    "assessmentId": 11,
    "assessmentUniqueId": 1762473685568,
  ...
  "questions": [
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>Array.create()</pre>",
        "B": "<pre>Array.of()</pre>",
        "C": "<pre>Array.make()</pre>",
        "D": "<pre>Array.from()</pre>"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>arr.getLast()</pre>",
        "B": "<pre>arr.last()</pre>",
        "C": "<pre>arr[-1]</pre>",
        "D": "<pre>arr[arr.length - 1]</pre>"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "D": "Replaces all elements with 0"
      },
      "correct": "D",
