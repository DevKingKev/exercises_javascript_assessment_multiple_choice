// assessment17.js - AUTO-GENERATED topics and assessmentId
const metadata = {
    ...
    "assessmentId": 17,
    "assessmentUniqueId": 1730726412000,
...
const questions = [
    ...
    },
    {
        ...
        "options": {
            "A": "There's no direct method, use Array.from(str)",
            "B": "<pre>str.toArray()</pre>",
            "C": "<pre>str.codeUnits()</pre>",
            "D": "<pre>String.toCodeUnits(str)</pre>"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "options": {
            "A": "<pre>regex.test(str)</pre>",
            "B": "<pre>str.matches(regex)</pre>",
            "C": "<pre>str.test(regex)</pre>",
    ...
    },
    {
        ...
        "options": {
            "A": "<pre>String(obj)</pre>",
            "B": "<pre>obj.toText()</pre>",
            "C": "<pre>obj.stringify()</pre>",
    ...
    },
    {
        ...
        "options": {
            "A": "<pre>str.includes(substring)</pre>",
            "B": "<pre>str.contains(substring)</pre>",
            "C": "<pre>str.has(substring)</pre>",
            "D": "<pre>String.includes(str, substring)</pre>"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "options": {
            "A": "<pre>for (const char of str) {}</pre>",
            "B": "<pre>str.forEach(char => {})</pre>",
            "C": "<pre>for (const char in str) {}</pre>",
            "D": "<pre>String.iterate(str, char => {})</pre>"
        },
        "correct": "A",
