module.exports = {
  ...
  "questions": [
    ...
    },
    {
      ...
      "options": {
        "A": "They don't call other functions",
        "B": "They return expected outputs for given inputs",
        "C": "They have fewer than 10 lines of code",
        "D": "They use the latest JavaScript features"
      },
      "correct": "B",
    ...
    },
    {
      ...
      "options": {
        "A": "Testing with old browsers",
        "B": "Ensuring new changes don't break existing features",
        "C": "Going back to fix old bugs",
        "D": "Testing only the oldest parts of the code"
      },
      "correct": "B",
    ...
    },
    {
      ...
      "options": {
        "A": "A funny test name",
        "B": "A fake object that simulates real dependencies",
    ...
    },
    {
      ...
      "options": {
        "A": "They make refactoring faster",
        "B": "They ensure changes don't break existing behavior",
    ...
    },
    {
      ...
      "options": {
        "A": "Writes tests automatically",
        "B": "Executes tests and reports results",
    ...
    },
    {
      ...
      "options": {
        "A": "Only what the documentation says",
        "B": "Normal cases, edge cases, and error cases",
        "C": "Just the function name",
        "D": "Only the most common use case"
      },
      "correct": "B",
    ...
    },
    {
      ...
      "options": {
        "A": "How many developers reviewed the code",
        "B": "A measure of how much code is executed by tests",
    ...
    },
    {
      ...
      "options": {
        "A": "Tests write themselves",
        "B": "No need for manual testing ever",
        "C": "Tests can run quickly and repeatedly",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "Testing valid inputs that should work",
    ...
    },
    {
      ...
      "options": {
        "A": "Testing with negative numbers",
        "B": "A test that always fails",
        "C": "Testing invalid inputs and error conditions",
    ...
    },
    {
      ...
      "options": {
        "A": "Error (red), success (green), repeat (refactor)",
        "B": "Stop (red), go (green), wait (refactor)",
        "C": "Write failing test (red), make it pass (green), improve code (refactor)",
    ...
    },
    {
      ...
      "options": {
        "A": "To satisfy the test framework",
        "B": "To make tests look professional",
        "C": "To clearly explain what the test verifies",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Testing with real user data",
        "C": "Testing the user interface only",
        "D": "Testing how multiple units work together"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "They find more bugs",
        "D": "They encourage frequent test execution"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "assert.true(condition)",
        "B": "check.same(actual, expected)",
    ...
    },
    {
      ...
      "options": {
        "A": "Only fix it before releasing",
        "B": "Immediately delete the test",
        "C": "Ignore it if it's a small issue",
        "D": "Investigate and fix the cause of failure"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "D": "Easier to identify exactly what's broken"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "Testing two functions together",
        "B": "Running the same test twice",
        "C": "A backup test file",
        "D": "A generic term for test fakes, mocks, and stubs"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "It reduces documentation needs",
        "B": "It makes code reviews faster",
        "C": "It eliminates meetings",
        "D": "It helps prevent breaking others' code"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "D": "Understand what behavior you want to verify"
      },
