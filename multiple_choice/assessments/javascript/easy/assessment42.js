  ...
  "questions": [
    {
      ...
      "options": {
        "A": "To measure code performance",
        "B": "To test the entire application at once",
        "C": "To check if the UI looks good",
        "D": "To verify individual code units work correctly"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "Checks if actual result matches expected result",
        "D": "Creates test data"
      },
      "correct": "C",
    ...
    },
    {
      ...
      "options": {
        "A": "Complex and testing many things at once",
        "B": "Isolated and focused on one behavior",
    ...
    },
    {
      ...
      "options": {
        "A": "A bug report from users",
        "B": "A specific scenario with inputs and expected outputs",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "The code doesn't behave as expected",
    ...
    },
    {
      ...
      "options": {
        "A": "Test only after all code is written",
        "B": "Write documentation after writing tests",
        "C": "Write tests before writing implementation code",
    ...
    },
    {
      ...
      "options": {
        ...
        "D": "They return expected outputs for given inputs"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "D": "Ensuring new changes don't break existing features"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "D": "Normal cases, edge cases, and error cases"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "A measure of how much code is executed by tests",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Tests can run quickly and repeatedly",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "All of the above",
        "D": "Because they're individual units"
      },
      "correct": "C",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "They encourage frequent test execution",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "expect(actual).toEqual(expected)",
