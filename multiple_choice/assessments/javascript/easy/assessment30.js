// assessment30.js - AUTO-GENERATED topics and assessmentId
const metadata = {
...
const questions = [
    {
        ...
        "topic": {
            "topics": ["Key coercion in objects"]
        }
    },
    {
        "id": 2,
    ...
    },
    {
        ...
        "options": {
            "A": "They get converted to strings 'true'/'false'",
            "B": "They stay as booleans",
    ...
    },
    {
        ...
        "options": {
            "A": "Yes, functions can be Map keys",
            "B": "No, only primitives allowed",
            "C": "Only arrow functions",
            "D": "Functions get converted to strings"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "options": {
            "A": "Treats them as the same value",
            "B": "Treats them as different values",
            "C": "Converts -0 to +0",
    ...
    },
    {
        ...
        "options": {
            "A": "All arrays become the same '[object Object]' key",
            "B": "Arrays cannot be object keys",
            "C": "Only empty arrays work as keys",
    ...
    },
    {
        ...
        "options": {
            "A": "They become strings 'null' and 'undefined'",
            "B": "They cause errors",
            "C": "They stay as null and undefined",
            "D": "They become empty strings"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "options": {
            "A": "Uses SameValueZero algorithm",
            "B": "Uses loose equality ==",
            "C": "Uses strict equality ===",
    ...
    },
    {
        ...
        "options": {
            "A": "Preserves number type without string conversion",
            "B": "Automatically sorts numeric keys",
    ...
    },
    {
        ...
        "options": {
            "A": "It stays as a Symbol without conversion",
    ...
    },
    {
        ...
        "options": {
            "A": "Treats them as different keys",
            "B": "Treats them as the same key",
            "C": "Compares their properties",
            "D": "Converts them to strings first"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "options": {
            "A": "When you need to preserve key types",
            "B": "When you need JSON serialization",
            "C": "When you need prototype methods",
    ...
    },
    {
        ...
        "options": {
            "A": "Accidental key overwrites due to string conversion",
            "B": "Numbers being too large as keys",
            "C": "Automatic sorting of numeric keys",
    ...
    },
    {
        ...
        "options": {
            "A": "Each object reference is unique",
            "B": "Objects with same content are deduplicated",
            "C": "Objects cannot be added to Set",
    ...
    },
    {
        ...
        "options": {
            "A": "DOM elements can be used as keys directly",
            "B": "Map is faster for DOM operations",
            "C": "Objects cannot store DOM references",
