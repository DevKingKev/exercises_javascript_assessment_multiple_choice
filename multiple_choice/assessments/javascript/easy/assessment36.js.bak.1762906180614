  ...
  "questions": [
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Add strategic console.log statements",
    ...
    },
    {
      ...
      "options": {
        "A": "Use console.listeners()",
        "B": "Check Event Listeners tab in Elements panel",
    ...
    },
    {
      ...
      "options": {
        "A": "Faster execution",
        "B": "Easier to read structured data",
        "C": "Smaller output",
    ...
    },
    {
      ...
      "options": {
        "A": "Set breakpoints on every line",
        "B": "Use 'Step over' button repeatedly",
        "C": "Use console.step()",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "There's no built-in method",
        "D": "Use a flag variable"
      },
      "correct": "C",
    ...
    },
    {
      ...
      "options": {
        "A": "Measures memory usage only",
        "B": "Creates user profiles",
        "C": "Profiles network performance",
        "D": "Starts JavaScript CPU profiling"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "D": "Use the browser console directly"
      },
      "correct": "A",
    ...
    },
    {
      ...
      "options": {
        "A": "Logs more information",
        "B": "Faster to type",
        "C": "Works without developer tools",
        "D": "Allows interactive inspection of current state"
      },
      "correct": "D",
