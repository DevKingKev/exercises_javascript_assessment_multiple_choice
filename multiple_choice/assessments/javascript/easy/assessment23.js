// assessment23.js - AUTO-GENERATED topics and assessmentId
const metadata = {
...
const questions = [
    ...
    },
    {
        ...
        "topic": {
            "topics": ["Object creation methods"]
        }
    },
    {
        "id": 3,
    ...
    },
    {
        ...
        "options": {
            "A": "It searches the object first, then the prototype chain",
            "B": "It only searches the object itself",
            "C": "It searches the prototype chain first",
            "D": "It searches global variables"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "options": {
            "A": "To get the prototype of an object",
    ...
    },
    {
        ...
        "options": {
            "A": "It always creates or updates an own property",
            "B": "It updates the prototype property",
    ...
    },
    {
        ...
        "options": {
            "A": "Function → Function.prototype → Object.prototype → null",
    ...
    },
    {
        ...
        "options": {
            "A": "<pre>object.hasOwnProperty('name')</pre>",
            "B": "<pre>'name' in object</pre>",
            "C": "<pre>object.exists('name')</pre>",
    ...
    },
    {
        ...
        "options": {
            "A": "Instances inherit from constructor's prototype",
            "B": "Constructors inherit from instances",
    ...
    },
    {
        ...
        "options": {
            "A": "The property is removed from that object only",
    ...
    },
    {
        ...
        "options": {
            "A": "To change an object's prototype after creation",
            "B": "To get an object's prototype",
    ...
    },
    {
        ...
        "options": {
            "A": "All instances immediately see the updated method",
            "B": "Only new instances see the update",
            "C": "Existing instances keep the old method",
            "D": "It causes an error"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "options": {
            "A": "<pre>instanceof</pre> checks constructor, <pre>isPrototypeOf</pre> checks object",
    ...
    },
    {
        ...
        "options": {
            "A": "Using object literal syntax: <pre>{}</pre>",
            "B": "Using <pre>new Object()</pre>",
            "C": "Using <pre>Object.create()</pre>",
