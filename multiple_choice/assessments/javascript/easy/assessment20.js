// assessment20.js - AUTO-GENERATED topics and assessmentId
const metadata = {
...
const questions = [
    ...
    },
    {
        ...
        "options": {
            "A": "It references the function that created the object",
            "B": "It creates new objects",
    ...
    },
    {
        ...
        "options": {
            "A": "JavaScript looks up the prototype chain",
    ...
    },
    {
        ...
        "options": {
            "A": "<pre>hasOwnProperty</pre> checks own properties, <pre>in</pre> checks prototype chain",
            "B": "<pre>hasOwnProperty</pre> is faster",
    ...
    },
    {
        ...
        "options": {
            "A": "It runs as a normal function, may pollute global scope",
    ...
    },
    {
        ...
        "options": {
            ...
            "C": "<pre>parentObj.clone()</pre>",
            "D": "<pre>Object.inherit(parentObj)</pre>"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "options": {
            "A": "All instances share the same method",
            "B": "Each instance gets its own copy",
            "C": "They are private to the constructor",
    ...
    },
    {
        ...
        "options": {
            "A": "Constructor's prototype is the prototype for instances",
    ...
    },
    {
        ...
        "options": {
            "A": "All instances immediately see the changes",
    ...
    },
    {
        ...
        "options": {
            ...
            "B": "<pre>obj.hasProperty('prop')</pre>",
            "C": "<pre>obj.exists('prop')</pre>",
            "D": "<pre>obj.prop !== undefined</pre>"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "options": {
            "A": "It points back to the constructor function",
    ...
    },
    {
        ...
        "options": {
            "A": "It uses prototypal inheritance",
            "B": "It uses classical inheritance",
            "C": "It doesn't support inheritance",
            "D": "It only uses interfaces"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "options": {
            "A": "The object's own property takes precedence",
            "B": "The prototype's property takes precedence",
            "C": "It causes an error",
            "D": "A random property is used"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "options": {
            "A": "Objects can directly inherit from other objects",
            "B": "It's faster than classical inheritance",
            "C": "It doesn't use memory",
            "D": "It only works with built-in types"
        },
        "correct": "A",
