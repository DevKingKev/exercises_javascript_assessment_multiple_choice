module.exports = {
  ...
  "questions": [
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>Object.get(obj, 'level1.level2')</pre>",
        "B": "<pre>obj.level1.level2</pre>",
        "C": "<pre>obj['level1']['level2']</pre>",
        "D": "<pre>obj?.level1?.level2</pre>"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>obj.method()</pre>",
        "B": "<pre>method.bind(obj)</pre>",
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>const obj = {name: 'John', greet: function() {}}</pre>",
        "B": "<pre>const obj = {name: 'John', function greet() {}}</pre>",
        "C": "<pre>const name = 'John'; const obj = {name, greet() {}}</pre>",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "There's no built-in method for all cases",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "<pre>Object.getOwnPropertyValues(obj)</pre>",
        "D": "Use a for...in loop and collect values"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "<pre>Object.keys(obj).forEach(key => {})</pre>",
        "C": "<pre>for (const value of obj) {}</pre>",
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>const {a: x, b: y} = {a: 1, b: 2}</pre>",
        "B": "<pre>const {x: a, y: b} = {a: 1, b: 2}</pre>",
        "C": "<pre>const x = a, y = b from {a: 1, b: 2}</pre>",
    ...
    },
    {
      ...
      "options": {
        ...
        "D": "<pre>Object.reference(obj)</pre>"
      },
      "correct": "B",
