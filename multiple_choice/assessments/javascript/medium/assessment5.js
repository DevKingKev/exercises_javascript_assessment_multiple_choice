  ...
  "questions": [
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "A function that only uses primitive types",
    ...
    },
    {
      ...
      "options": {
        "A": "It allows you to specify a custom 'this' binding for getter functions",
        "B": "It's significantly faster for large objects",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Converting objects to primitive values in type coercion contexts",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "They enable regex to match multiple patterns simultaneously",
        "C": "They allow accessing matched groups by name instead of index, improving readability",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "A callback function to access the module",
        "C": "A Promise that resolves to the module object",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "[CODE]Symbol.for()[/CODE] creates a symbol that can be serialized to JSON",
        "C": "[CODE]Symbol.for()[/CODE] is faster",
        "D": "[CODE]Symbol.for()[/CODE] creates or retrieves a globally shared symbol with the given key"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Strings are thrown faster",
        "C": "Error objects include stack traces and are more informative; strings don't",
