module.exports = {
    metadata: {
        ...
        assessmentId: 6,
        assessmentUniqueId: 1730899200000,
    ...
    questions: [
        {
            ...
            options: {
                A: "fetch() automatically retries failed requests",
                B: "fetch() only rejects on network errors, not HTTP errors like 404 or 500",
            ...
            topic: {
                topics: ["Fetch API and Request/Response"]
            }
        },
        {
            id: 2,
            ...
            options: {
                ...
                B: "Defines padding around the root element's bounding box for intersection calculations",
                C: "Specifies the minimum overlap percentage",
            ...
            topic: {
                topics: ["Intersection Observer API"]
            }
        },
        {
            id: 3,
            ...
            topic: {
                topics: ["Local Storage and Session Storage"]
            }
        },
        {
            id: 4,
        ...
        },
        {
            ...
            options: {
                ...
                B: "IndexedDB is asynchronous and can store much larger amounts of structured data",
                C: "IndexedDB works in all browsers including IE6",
        ...
        },
        {
            ...
            topic: {
                topics: ["Object.defineProperty and Descriptors"]
            }
        },
        {
            id: 7,
            ...
            options: {
                ...
                B: "An object with no prototype (truly empty object)",
                C: "An object with Object.prototype",
                D: "A null value"
            },
            correct: "B",
            ...
            topic: {
                topics: ["Object.create and Prototypal Patterns"]
            }
        },
        {
            id: 8,
        ...
        },
        {
            ...
            topic: {
                topics: ["Array.from and Iterable Protocol"]
            }
        },
        {
            id: 10,
        ...
        },
        {
            ...
            topic: {
                topics: ["Template Literals and Tagged Templates"]
            }
        },
        {
            id: 12,
            ...
            topic: {
                topics: ["Service Workers and Caching"]
            }
        },
        {
            id: 13,
        ...
        },
        {
            ...
            options: {
                A: "Session Storage is faster",
                B: "Session Storage data persists only for the browser session/tab",
        ...
        },
        {
            ...
            options: {
                ...
                B: "The percentage of target element visibility that triggers the callback",
                C: "The maximum number of elements to observe",
                D: "The minimum element size to observe"
            },
            correct: "B",
        ...
        },
        {
            ...
            options: {
                ...
                B: "Forces the new service worker to activate immediately without waiting",
                C: "Skips caching static assets",
                D: "Bypasses the fetch event"
            },
            correct: "B",
        ...
        },
        {
            ...
            options: {
                A: "It throws an error",
                B: "It converts them to arrays by copying indexed properties",
                C: "It only works with true arrays",
                D: "It requires manual conversion"
            },
            correct: "B",
        ...
        },
        {
            ...
            options: {
                A: "Memory leak as the response stream remains open",
                B: "Automatic cleanup happens",
        ...
        },
        {
            ...
            options: {
                A: "It throws an error",
                B: "Unspecified descriptors default to false/undefined",
                C: "It keeps existing descriptor values",
        ...
        },
        {
            ...
            options: {
                A: "Disables Service Worker caching only",
                B: "Prevents both HTTP cache and browser cache from storing the response",
        ...
        },
        {
            ...
            options: {
                ...
                B: "Show a notification and let users refresh manually",
                C: "Block until update completes",
        ...
        },
        {
            ...
            options: {
                ...
                C: "An array of strings as first parameter, then individual interpolated values",
                D: "Just the interpolated values"
            },
            correct: "C",
