module.exports = {
  "metadata": {
    ...
    "assessmentId": 7,
    "assessmentUniqueId": 1762343141335,
  ...
  "questions": [
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>==</pre> performs type coercion before comparison; <pre>===</pre> checks type and value without coercion",
        "B": "<pre>==</pre> is faster than <pre>===</pre>",
    ...
    },
    {
      ...
      "options": {
        "A": "The time between entering scope and variable initialization where <pre>let</pre>/<pre>const</pre> variables cannot be accessed",
        "B": "The delay in async operations",
    ...
    },
    {
      ...
      "options": {
        "A": "Short-circuits and returns <pre>undefined</pre> if the reference is <pre>null</pre> or <pre>undefined</pre>",
        "B": "Makes properties optional in type definitions",
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>??</pre> only returns the right operand for <pre>null</pre>/<pre>undefined</pre>; <pre>||</pre> returns it for any falsy value",
    ...
    },
    {
      ...
      "options": {
        "A": "Prefixing the field name with <pre>#</pre>",
        "B": "Using <pre>_</pre> prefix by convention",
        "C": "Using the <pre>private</pre> keyword",
    ...
    },
    {
      ...
      "options": {
        "A": "Representing integers larger than <pre>Number.MAX_SAFE_INTEGER</pre> (2^53 - 1)",
        "B": "Optimizing memory usage",
        "C": "Compressing large data structures",
        "D": "Storing large floating-point numbers"
      },
      "correct": "A",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Creates static methods",
        "C": "Runs once when the class is defined, useful for complex static initialization",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "Assigns only if the left operand is truthy",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "<pre>const</pre> doesn't work with objects",
        "C": "The variable binding is immutable, but object properties can still be modified",
        "D": "The object is frozen automatically"
      },
      "correct": "C",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Merges objects",
        "C": "Assigns only if left is <pre>null</pre> or <pre>undefined</pre>",
        "D": "Performs null checks"
      },
      "correct": "C",
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>_field</pre> is faster",
        "B": "They are the same",
        "C": "<pre>#field</pre> is truly private and inaccessible outside the class; <pre>_field</pre> is just a naming convention",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "It throws a ReferenceError at runtime",
        "C": "It works normally",
        "D": "It's a SyntaxError caught at parse time"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "Global <pre>isFinite()</pre> is more accurate",
        "B": "They are identical",
        "C": "<pre>Number.isFinite()</pre> is deprecated",
        "D": "<pre>Number.isFinite()</pre> doesn't coerce non-numbers; global <pre>isFinite()</pre> does"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "It only works with object properties",
        "B": "It cannot be used with functions",
        "C": "It always throws an error",
        "D": "It safely calls functions and returns <pre>undefined</pre> if the function doesn't exist"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "They are identical",
        "B": "<pre>Number()</pre> only works with integers",
        "C": "<pre>parseInt()</pre> is more accurate",
        "D": "<pre>Number()</pre> is strict and rejects invalid formats; <pre>parseInt()</pre> parses until invalid character"
      },
      "correct": "D",
