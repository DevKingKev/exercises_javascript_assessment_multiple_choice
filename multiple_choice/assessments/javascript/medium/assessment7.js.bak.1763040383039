  ...
  "questions": [
    ...
    },
    {
      ...
      "options": {
        ...
        "D": "The time between entering scope and variable initialization where <pre>let</pre>/<pre>const</pre> variables cannot be accessed"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "Prefixing the field name with <pre>#</pre>",
    ...
    },
    {
      ...
      "options": {
        ...
        "D": "Representing integers larger than <pre>Number.MAX_SAFE_INTEGER</pre> (2^53 - 1)"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "<pre>Object.is()</pre> performs type coercion",
        "C": "<pre>Object.is()</pre> handles <pre>NaN</pre> and <pre>-0</pre>/<pre>+0</pre> differently than <pre>===</pre>",
    ...
    },
    {
      ...
      "options": {
        ...
        "D": "The variable binding is immutable, but object properties can still be modified"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "D": "Assigns only if left is <pre>null</pre> or <pre>undefined</pre>"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>#field</pre> is truly private and inaccessible outside the class; <pre>_field</pre> is just a naming convention",
        "B": "They are the same",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "It's a SyntaxError caught at parse time",
        "D": "It works normally"
      },
      "correct": "C",
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>Number.isFinite()</pre> doesn't coerce non-numbers; global <pre>isFinite()</pre> does",
    ...
    },
    {
      ...
      "options": {
        "A": "It safely calls functions and returns <pre>undefined</pre> if the function doesn't exist",
