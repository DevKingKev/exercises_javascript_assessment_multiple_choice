module.exports = {
  "metadata": {
    ...
    "topicLinks": [
      {
        "topicName": "DOM traversal and manipulation",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/API/Document_Object_Model/Introduction"
      },
      {
        "topicName": "Event delegation",
        "refLink": "https://developer.mozilla.org/en-US/docs/Learn/JavaScript/Building_blocks/Events#event_delegation"
      },
      {
        "topicName": "Shadow DOM and encapsulation",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/Web_Components/Using_shadow_DOM"
      },
      {
        "topicName": "Custom Elements",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/Web_Components/Using_custom_elements"
      },
      {
        "topicName": "Template and cloning",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/HTML/Element/template"
      },
      {
        "topicName": "Selectors API",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/API/Document/querySelector"
      },
      {
        "topicName": "MutationObserver",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/API/MutationObserver"
      },
      {
        "topicName": "Node and Element interfaces",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/API/Node"
      },
      {
        "topicName": "focus and accessibility",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/Accessibility"
      },
      {
        "topicName": "Element.getBoundingClientRect",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/API/Element/getBoundingClientRect"
      }
    ]
  },
  "questions": [
    ...
    },
    {
      ...
      "options": {
        "A": "document.importNode(template.content, true)",
        "B": "template.cloneNode(false)",
        "C": "use innerHTML on the template element",
        "D": "call template.content.toString()"
      },
      "correct": "A",
    ...
    },
    {
      ...
      "options": {
        "A": "Global styles always penetrate shadow roots",
        "B": "Styles inside a shadow root do not affect the main document",
        "C": "Shadow DOM prevents any style inheritance",
        "D": "Styles from outside cannot affect anything inside a shadow root under any circumstances"
      },
      "correct": "B",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "element.querySelector(selector)",
    ...
    },
    {
      ...
      "options": {
        "A": "MutationObserver on attributes only",
        "B": "IntersectionObserver",
        "C": "ResizeObserver",
        "D": "setInterval polling"
      },
      "correct": "C",
