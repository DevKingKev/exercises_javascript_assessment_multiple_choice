// assessment8.js - HTML Meta Tags & SEO Basics
const metadata = {
...
const questions = [
    {
        ...
        "topic": {
            "topics": ["Character Encoding", "Meta Tags"]
        }
    },
    {
        "id": 2,
        ...
        "topic": {
            "topics": ["Viewport Configuration", "Responsive Design"]
        }
    },
    {
        "id": 3,
    ...
    },
    {
        ...
        "topic": {
            "topics": ["Document Metadata", "Meta Tags"]
        }
    },
    {
        "id": 6,
        ...
        "topic": {
            "topics": ["Open Graph Protocol", "Social Media Sharing"]
        }
    },
    {
        "id": 7,
        ...
        "topic": {
            "topics": ["Favicons", "Document Metadata"]
        }
    },
    {
        "id": 8,
    ...
    },
    {
        ...
        "options": {
            "A": "<pre><meta property=\"og:title\" content=\"Page Title\"></pre>",
            "B": "<pre><meta name=\"og:title\" content=\"Page Title\"></pre>",
            "C": "<pre><meta property=\"share:title\" content=\"Page Title\"></pre>",
    ...
    },
    {
        ...
        "options": {
            ...
            "D": "<pre><meta name=\"search\" content=\"exclude\"></pre>"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "options": {
            "A": "The image to display when the page is shared",
            "B": "The background image for the page",
            "C": "The site logo for search results",
            "D": "The author's profile picture"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "options": {
            "A": "Specifies the type of metadata",
            "B": "Names the meta tag for CSS targeting",
        ...
        "topic": {
            "topics": ["Meta Tags", "Document Metadata"]
        }
    },
    {
        "id": 15,
        ...
        "options": {
            "A": "<pre><meta http-equiv=\"refresh\" content=\"5\"></pre>",
            "B": "<pre><meta name=\"refresh\" content=\"5\"></pre>",
    ...
    },
    {
        ...
        "options": {
            "A": "The description shown when shared on social media",
            "B": "The page description for search engines",
    ...
    },
    {
        ...
        "options": {
            "A": "<pre><link rel=\"apple-touch-icon\" href=\"icon.png\"></pre>",
            "B": "<pre><meta name=\"apple-icon\" href=\"icon.png\"></pre>",
            "C": "<pre><icon rel=\"apple\" href=\"icon.png\"></pre>",
    ...
    },
    {
        ...
        "options": {
            "A": "Contains the actual metadata value",
            "B": "Specifies the content type of the page",
            "C": "Defines the page's main content",
            "D": "Sets the character content limit"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "options": {
            "A": "<pre><meta property=\"og:url\" content=\"https://example.com/page\"></pre>",
            "B": "<pre><meta name=\"og:url\" content=\"https://example.com/page\"></pre>",
            "C": "<pre><meta property=\"share:url\" content=\"https://example.com/page\"></pre>",
            "D": "<pre><meta name=\"social:url\" content=\"https://example.com/page\"></pre>"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "options": {
            "A": "Prevents users from zooming the page",
            "B": "Allows unlimited zooming",
            "C": "Sets default zoom level",
        ...
        "topic": {
            "topics": ["Viewport Configuration", "Accessibility"]
        }
    },
    {
        "id": 21,
        ...
        "options": {
            "A": "The <pre>lang</pre> attribute on the <pre><html></pre> tag",
            "B": "<pre><meta name=\"language\" content=\"en\"></pre>",
            "C": "<pre><meta http-equiv=\"content-language\" content=\"en\"></pre>",
            "D": "<pre><meta property=\"og:locale\" content=\"en_US\"></pre>"
        },
        "correct": "A",
        ...
        "topic": {
            "topics": ["Document Metadata", "Accessibility"]
        }
    },
    {
        "id": 22,
        ...
        "options": {
            "A": "Specifies the type of content (article, website, etc.)",
            "B": "Defines the content category",
            "C": "Sets the media type (text, video, image)",
    ...
    },
    {
        ...
        "options": {
            "A": "<pre><meta name=\"theme-color\" content=\"#ffffff\"></pre>",
            "B": "<pre><meta name=\"color\" content=\"#ffffff\"></pre>",
            "C": "<pre><meta property=\"theme:color\" content=\"#ffffff\"></pre>",
        ...
        "topic": {
            "topics": ["Meta Tags", "User Experience"]
        }
    },
    {
        "id": 24,
        ...
        "options": {
            "A": "Prevents users from zooming in beyond 100%",
            "B": "Allows unlimited zooming",
            "C": "Sets the maximum page scale",
            "D": "Enables automatic maximum scaling"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "options": {
            "A": "<pre><meta name=\"twitter:card\" content=\"summary\"></pre>",
            "B": "<pre><meta property=\"twitter:card\" content=\"summary\"></pre>",
            "C": "<pre><meta name=\"twitter-card\" content=\"summary\"></pre>",
            "D": "<pre><meta property=\"twitter-card\" content=\"summary\"></pre>"
        },
        "correct": "A",
        ...
        "topic": {
            "topics": ["Social Media Sharing", "Meta Tags"]
        }
    },
    {
        "id": 26,
        ...
        "options": {
            "A": "Provides HTTP header equivalent functionality",
            "B": "Defines HTML equivalent content",
            "C": "Specifies HTTP error handling",
            "D": "Sets HTTP request methods"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "options": {
            "A": "<pre><meta property=\"og:site_name\" content=\"Site Name\"></pre>",
            "B": "<pre><meta name=\"og:site_name\" content=\"Site Name\"></pre>",
            "C": "<pre><meta property=\"site:name\" content=\"Site Name\"></pre>",
            "D": "<pre><meta name=\"site_name\" content=\"Site Name\"></pre>"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "options": {
            "A": "Use multiple <pre><link rel=\"icon\"></pre> tags with different sizes",
            "B": "Use a single meta tag with multiple size values",
            "C": "Use CSS to resize a single favicon",
            "D": "Use JavaScript to dynamically set favicon size"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "options": {
            "A": "The language and region for the content",
            "B": "The server location",
            "C": "The target audience location",
            "D": "The content distribution region"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "options": {
            "A": "<pre><meta name=\"google-site-verification\" content=\"code\"></pre>",
            "B": "<pre><meta name=\"verification\" content=\"code\"></pre>",
            "C": "<pre><meta property=\"site-verification\" content=\"code\"></pre>",
            "D": "<pre><meta http-equiv=\"verification\" content=\"code\"></pre>"
        },
        "correct": "A",
