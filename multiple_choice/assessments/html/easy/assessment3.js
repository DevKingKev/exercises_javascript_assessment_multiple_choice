// assessment3.js - HTML Multimedia and Embedded Content
const metadata = {
...
const questions = [
    ...
    },
    {
        ...
        "topic": {
            "topics": ["Audio and video elements"]
        }
    },
    {
        "id": 3,
    ...
    },
    {
        ...
        "options": {
            "A": "Defers loading the image until it's near the viewport",
            "B": "Loads the image slowly",
    ...
    },
    {
        ...
        "options": {
            "A": "How much video data to load before playback",
            "B": "Whether to show a preloader animation",
    ...
    },
    {
        ...
        "options": {
            "A": "Serves different images based on screen size",
            "B": "Creates an image gallery",
            "C": "Adds a picture frame",
    ...
    },
    {
        ...
        "options": {
            "A": "Provides multiple image resolutions for responsive loading",
            "B": "Sets multiple image sources to choose from",
            "C": "Creates an image set for galleries",
            "D": "Defines image source code"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "options": {
            "A": "Repeats the audio continuously when it ends",
            "B": "Creates an audio loop effect",
    ...
    },
    {
        ...
        "options": {
            "A": "Restricts iframe capabilities for security",
            "B": "Creates a sandbox environment theme",
            "C": "Enables testing mode",
            "D": "Adds a sandbox border"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "options": {
            "A": "Specifies the type of text track (subtitles, captions, etc.)",
            "B": "Defines the track quality",
            "C": "Sets the track format",
            "D": "Specifies track kindness level"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "options": {
            "A": "Allows video to play inline instead of fullscreen",
            "B": "Aligns the video inline with text",
            "C": "Plays the video in a straight line",
    ...
    },
    {
        ...
        "options": {
            "A": "How much screen space the image will occupy at different breakpoints",
            "B": "The actual image file sizes",
            "C": "Multiple size options for users",
    ...
    },
    {
        ...
        "options": {
            "A": "Controls CORS requests for cross-origin images",
            "B": "Allows crossing image boundaries",
            "C": "Enables cross-browser compatibility",
            "D": "Creates crosshair cursors"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "options": {
            "A": "Users from enabling picture-in-picture mode",
            "B": "Displaying the video poster",
