module.exports = {
  ...
  "questions": [
    ...
    },
    {
      ...
      "options": {
        "A": "Displays play, pause, and volume controls",
        "B": "Allows controlling the video with keyboard only",
        "C": "Enables parental controls",
    ...
    },
    {
      ...
      "options": {
        "A": "Groups an image with its caption",
        "B": "Creates a thumbnail gallery",
    ...
    },
    {
      ...
      "options": {
        "A": "Alternative text for accessibility and when images fail to load",
        "B": "An alternate image source",
        "C": "Image alignment settings",
        "D": "A tooltip on hover"
      },
      "correct": "A",
    ...
    },
    {
      ...
      "options": {
        "A": "Removes the audio track entirely",
        "B": "Starts the video with audio muted",
        "C": "Prevents unmuting",
    ...
    },
    {
      ...
      "options": {
        "A": "<pre><video src=\"youtube.com/VIDEO_ID\"></video></pre>",
        "B": "<pre><iframe src=\"https://www.youtube.com/embed/VIDEO_ID\"></iframe></pre>",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Subtitles, captions, or other timed text tracks",
        "C": "Audio tracks for the video",
    ...
    },
    {
      ...
      "options": {
        "A": "Image distortion",
        "B": "Layout shift when the page loads",
        "C": "Browser scaling",
        "D": "Image downloading"
      },
      "correct": "B",
    ...
    },
    {
      ...
      "options": {
        "A": "Embeds CSS styles",
        "B": "Embeds external content like PDFs or Flash (deprecated)",
        "C": "Embeds JavaScript code",
        "D": "Embeds videos only"
      },
      "correct": "B",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "Provides multiple image resolutions for responsive loading",
        "D": "Creates an image set for galleries"
      },
      "correct": "C",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Plays the audio twice",
        "C": "Repeats the audio continuously when it ends",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "Provides a caption for content inside <pre><figure></figure></pre>",
        "D": "Adds figure numbers automatically"
      },
      "correct": "C",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "Restricts iframe capabilities for security",
        "D": "Enables testing mode"
      },
      "correct": "C",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "<pre><iframe></pre> has better quality",
        "C": "<pre><video></pre> plays local files; <pre><iframe></pre> embeds external players",
    ...
    },
    {
      ...
      "options": {
        "A": "Encrypts the image asynchronously",
        "B": "Decodes the image format",
        "C": "Allows asynchronous image decoding for better performance",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "Enables inline editing",
        "D": "Allows video to play inline instead of fullscreen"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "The image dimensions in the HTML",
        "D": "How much screen space the image will occupy at different breakpoints"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "Creates camera and microphone controls",
        "B": "Displays camera and microphone icons",
        "C": "Allows audio and video playback",
        "D": "Grants the iframe permission to access camera and microphone"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "D": "Use <pre><map></pre> with <pre><area></pre> elements"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Showing video controls",
        "C": "Playing the video in fullscreen",
        "D": "Users from enabling picture-in-picture mode"
      },
      "correct": "D",
