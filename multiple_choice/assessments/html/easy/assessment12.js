module.exports = {
  ...
  "questions": [
    ...
    },
    {
      ...
      "options": {
        "A": "Image file source information",
        "B": "Text description for screen readers and when images fail to load",
    ...
    },
    {
      ...
      "options": {
        "A": "It improves SEO ranking",
        "B": "Many users navigate using keyboard only",
        "C": "It's required for mobile devices",
        "D": "Keyboard navigation is faster than mouse"
      },
      "correct": "B",
    ...
    },
    {
      ...
      "options": {
        "A": "Always use ARIA for better accessibility",
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>aria-label</pre> adds to visible text",
        "B": "<pre>aria-label</pre> overrides visible text for screen readers",
    ...
    },
    {
      ...
      "options": {
        "A": "Indicates the page's header content",
        "B": "Identifies the primary content of the page",
        "C": "Defines the main navigation area",
        "D": "Marks the most important heading"
      },
      "correct": "B",
    ...
    },
    {
      ...
      "options": {
        "A": "When you want to hide the description",
        "B": "When you have longer, more detailed descriptions",
    ...
    },
    {
      ...
      "options": {
        "A": "It improves mobile responsiveness",
        "B": "It ensures text is readable for users with low vision",
    ...
    },
    {
      ...
      "options": {
        "A": "Makes it look like a button visually",
        "B": "Tells screen readers it functions as a button",
    ...
    },
    {
      ...
      "options": {
        "A": "Using Enter key repeatedly",
        "B": "Using Arrow keys only",
        "C": "Using Tab and Shift+Tab keys",
    ...
    },
    {
      ...
      "options": {
        "A": "Sets the language for CSS styling",
        "B": "Defines the programming language",
        "C": "Specifies the page's primary language for screen readers",
    ...
    },
    {
      ...
      "options": {
        "A": "When the element has a visual label",
        "B": "When the element is temporarily disabled",
        "C": "Never, it would make the element inaccessible",
    ...
    },
    {
      ...
      "options": {
        "A": "Only the visible text content",
        "B": "The button's CSS classes",
        "C": "The button's accessible name and role",
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>div</pre> buttons load faster",
        "B": "<pre>button</pre> elements are harder to style",
        "C": "<pre>button</pre> has built-in accessibility and behavior",
    ...
    },
    {
      ...
      "options": {
        "A": "Make elements more visually appealing",
        "B": "Indicate element hover states",
        "C": "Show which element currently has keyboard focus",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "It prevents form submission",
        "C": "It can connect error messages to form fields",
    ...
    },
    {
      ...
      "options": {
        "A": "Use colorful icons only",
        "B": "Make the icons larger for visibility",
        "C": "Place icons at the top of the page",
        "D": "Add <pre>aria-label</pre> to provide context"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "To test mobile responsiveness",
        "B": "To make websites load faster",
        "C": "To improve visual design",
        "D": "To understand the experience of blind and low-vision users"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "Automatic translation features",
        "B": "Automatic reading assistance",
        "C": "Built-in styling for articles",
        "D": "A self-contained content landmark"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "Require mouse interaction only",
        "B": "Use number keys for quick selection",
        "C": "Use Tab key to move through all options",
        "D": "Use Arrow keys for navigation and Enter/Space for selection"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "D": "Associates text with form controls for accessibility"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "It makes videos load slower",
        "B": "It improves page performance",
        "C": "It's required for mobile devices",
        "D": "It can be disruptive for screen reader users"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "Use the latest JavaScript frameworks",
        "B": "Make websites visually appealing",
        "C": "Optimize for search engines",
        "D": "Ensure content is perceivable, operable, and understandable"
      },
      "correct": "D",
