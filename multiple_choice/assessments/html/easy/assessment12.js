  ...
  "questions": [
    {
      ...
      "options": {
        "A": "Specifies the element's CSS styling",
        "B": "Sets the element's visual appearance",
        "C": "Defines the element's behavior in JavaScript",
        "D": "Defines what type of element something is for assistive technology"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "A CSS class for styling",
        "B": "A visual label for sighted users",
        "C": "An accessible name for screen reader users",
    ...
    },
    {
      ...
      "options": {
        "A": "For all interactive elements",
        "B": "Only for complex widgets",
        "C": "When you need custom styling",
        "D": "Always, when native HTML elements are available"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "Hides descriptive content from screen readers",
        "B": "Links an element to additional descriptive content",
    ...
    },
    {
      ...
      "options": {
        "A": "For all images on the page",
        "B": "For important content that should be hidden",
        "C": "For decorative elements that don't need screen reader attention",
    ...
    },
    {
      ...
      "options": {
        "A": "Defines table indexing",
        "B": "Creates tabbed content interfaces",
        "C": "Sets the element's z-index value",
        "D": "Controls keyboard navigation order and focus"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "D": "Many users navigate using keyboard only"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "D": "Identifies the primary content of the page"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "It ensures text is readable for users with low vision",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Specifies the page's primary language for screen readers",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "The button's accessible name and role",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "<pre>button</pre> has built-in accessibility and behavior",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Show which element currently has keyboard focus",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "It can connect error messages to form fields",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "Add <pre>aria-label</pre> to provide context",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Use Arrow keys for navigation and Enter/Space for selection",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "It can be disruptive for screen reader users",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "Ensure content is perceivable, operable, and understandable",
