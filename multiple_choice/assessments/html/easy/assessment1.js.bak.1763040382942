module.exports = {
  ...
  "questions": [
    ...
    },
    {
      ...
      "options": {
        "A": "A bulleted (unordered) list",
        "B": "A numbered (ordered) list",
    ...
    },
    {
      ...
      "options": {
        "A": "Adds a hashtag to the URL",
        "B": "Creates a social media link",
        "C": "Opens a new section",
        "D": "Links to an element with id=\"section1\" on the same page"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "Hidden content",
        "D": "Content indirectly related to main content, like sidebars"
      },
      "correct": "D",
