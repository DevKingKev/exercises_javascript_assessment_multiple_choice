// assessment11.js - HTML Entities and Special Characters in Practice
const metadata = {
...
const questions = [
    {
        ...
        "topic": {
            "topics": ["Business Applications", "Common Entity Usage"]
        }
    },
    {
        "id": 2,
        ...
        "topic": {
            "topics": ["Measurement Units", "Technical Documentation"]
        }
    },
    {
        "id": 3,
        ...
        "topic": {
            "topics": ["Legal Notices", "Business Applications"]
        }
    },
    {
        "id": 4,
        ...
        "topic": {
            "topics": ["Content Formatting", "Common Entity Usage"]
        }
    },
    {
        "id": 5,
    ...
    },
    {
        ...
        "topic": {
            "topics": ["Financial Displays", "International Content"]
        }
    },
    {
        "id": 7,
        ...
        "topic": {
            "topics": ["Technical Documentation", "Common Entity Usage"]
        }
    },
    {
        "id": 8,
        ...
        "topic": {
            "topics": ["Measurement Units", "Content Formatting"]
        }
    },
    {
        "id": 9,
    ...
    },
    {
        ...
        "options": {
            "A": "<pre>&amp;euro;10 &amp;ndash; &amp;euro;50</pre>",
            "B": "<pre>€10 - €50</pre>",
        ...
        "topic": {
            "topics": ["Financial Displays", "Content Formatting"]
        }
    },
    {
        "id": 11,
        ...
        "topic": {
            "topics": ["Measurement Units", "Text Alignment"]
        }
    },
    {
        "id": 12,
        ...
        "topic": {
            "topics": ["Mathematical Expressions", "Technical Documentation"]
        }
    },
    {
        "id": 13,
    ...
    },
    {
        ...
        "topic": {
            "topics": ["Content Formatting", "Measurement Units"]
        }
    },
    {
        "id": 16,
    ...
    },
    {
        ...
        "options": {
            "A": "<pre>Tech Innovations&amp;nbsp;LLC</pre>",
            "B": "<pre>Tech Innovations LLC</pre>",
            "C": "<pre>TechInnovationsLLC</pre>",
        ...
        "topic": {
            "topics": ["Business Applications", "Text Alignment"]
        }
    },
    {
        "id": 18,
        ...
        "options": {
            "A": "<pre>Area = 5 &amp;times; 3</pre>",
            "B": "<pre>Area = 5 x 3</pre>",
            "C": "<pre>Area = 5 * 3</pre>",
            "D": "<pre>Area = 15</pre>"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "topic": {
            "topics": ["Content Formatting", "Text Alignment"]
        }
    },
    {
        "id": 21,
    ...
    },
    {
        ...
        "topic": {
            "topics": ["Technical Documentation", "Mathematical Expressions"]
        }
    },
    {
        "id": 25,
    ...
    },
    {
        ...
        "options": {
            "A": "<pre>&amp;frac34; teaspoon salt</pre>",
            "B": "<pre>3/4 teaspoon salt</pre>",
            "C": "<pre>0.75 teaspoon salt</pre>",
            "D": "<pre>three quarters teaspoon salt</pre>"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "topic": {
            "topics": ["Technical Documentation", "Financial Displays"]
        }
    },
    {
        "id": 30,
        ...
        "options": {
            "A": "Ensures consistent display across different systems and languages",
        ...
        "topic": {
            "topics": ["International Content", "Common Entity Usage"]
        }
    }
];
