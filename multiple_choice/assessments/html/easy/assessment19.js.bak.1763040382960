    ...
    "questions": [
        {
            ...
            "topic": {
                "topics": ["Comment Syntax", "Code Quality"]
            }
        },
        {
            "id": 2,
            ...
            "options": {
                "A": "Comments slow down page loading",
                "B": "Too many comments make code harder to read",
            ...
            "topic": {
                "topics": ["Commenting Best Practices", "Code Readability"]
            }
        },
        {
            "id": 3,
            ...
            "topic": {
                "topics": ["Commenting Best Practices", "Code Organization"]
            }
        },
        {
            "id": 4,
            ...
            "options": {
                ...
                "B": "Comment out the section",
                "C": "Add the hidden attribute",
                "D": "Use CSS display: none"
            },
            "correct": "B",
            ...
            "topic": {
                "topics": ["Comment Syntax", "Maintenance Strategies"]
            }
        },
        {
            "id": 5,
            ...
            "options": {
                ...
                "B": "To serve different HTML to different browsers",
                "C": "To create comment forms",
            ...
            "topic": {
                "topics": ["Conditional Comments", "Code Organization"]
            }
        },
        {
            "id": 6,
            ...
            "topic": {
                "topics": ["Semantic HTML vs Comments", "Code Quality"]
            }
        },
        {
            "id": 7,
            ...
            "topic": {
                "topics": ["Code Organization", "Code Readability"]
            }
        },
        {
            "id": 8,
            ...
            "topic": {
                "topics": ["Commenting Best Practices", "Code Quality"]
            }
        },
        {
            "id": 9,
            ...
            "topic": {
                "topics": ["Code Organization", "Team Collaboration"]
            }
        },
        {
            "id": 10,
        ...
        },
        {
            ...
            "topic": {
                "topics": ["Commenting Best Practices", "Maintenance Strategies"]
            }
        },
        {
            "id": 12,
            ...
            "options": {
                "A": "<pre><!-- This is a div --></pre>",
                "B": "<pre><!-- Navigation menu for mobile devices --></pre>",
            ...
            "topic": {
                "topics": ["Commenting Best Practices", "Documentation"]
            }
        },
        {
            "id": 13,
            ...
            "options": {
                ...
                "C": "Completely deprecated and ignored",
                "D": "Work only in mobile browsers"
            },
            "correct": "C",
            ...
            "topic": {
                "topics": ["Conditional Comments", "Code Quality"]
            }
        },
        {
            "id": 14,
            ...
            "options": {
                "A": "Semantic elements are self-documenting",
                "B": "Semantic HTML automatically generates comments",
            ...
            "topic": {
                "topics": ["Semantic HTML vs Comments", "Code Readability"]
            }
        },
        {
            "id": 15,
            ...
            "options": {
                ...
                "B": "Mix uppercase and lowercase randomly",
                "C": "Be consistent with spacing and capitalization",
            ...
            "topic": {
                "topics": ["Commenting Best Practices", "Team Collaboration"]
            }
        },
        {
            "id": 16,
            ...
            "options": {
                "A": "To mark TODO items or temporary fixes",
        ...
        },
        {
            ...
            "options": {
                "A": "Remove all comments to improve performance",
                "B": "Keep only comments that provide value",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "They help team members navigate code quickly",
                "C": "They make HTML validate better",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "<pre><!-- ============ --></pre>",
                "C": "<pre><!-- ///////////// --></pre>",
                "D": "Any consistent style that's readable"
            },
            "correct": "D",
        ...
        },
        {
            ...
            "options": {
                "A": "They increase file size significantly",
                "B": "They can become outdated and misleading",
        ...
        },
        {
            ...
            "options": {
                "A": "Select lines and use Ctrl+/ or Cmd+/",
                "B": "Manually type <!-- on each line",
                "C": "Use a separate commenting tool",
                "D": "Copy and paste from another file"
            },
            "correct": "A",
            ...
            "topic": {
                "topics": ["Comment Syntax", "Code Organization"]
            }
        },
        {
            "id": 23,
            ...
            "options": {
                ...
                "B": "To clearly distinguish major sections",
                "C": "To increase comment character count",
        ...
        },
        {
            ...
            "options": {
                "A": "Always - semantic HTML is more meaningful",
                "B": "Only for screen reader users",
                "C": "When you want to hide content",
        ...
        },
        {
            ...
            "options": {
                "A": "Write comments that explain 'why' not just 'what'",
                "B": "Describe every HTML element in detail",
                "C": "Use technical jargon exclusively",
        ...
        },
        {
            ...
            "options": {
                "A": "They significantly slow down page loading",
                "B": "They have minimal impact on performance",
        ...
        },
        {
            ...
            "options": {
                "A": "It makes automated documentation possible",
                "B": "It improves SEO ranking",
                "C": "It changes comment color in browsers",
                "D": "It validates HTML better"
            },
            "correct": "A",
            ...
            "topic": {
                "topics": ["Documentation", "Team Collaboration"]
            }
        },
        {
            "id": 29,
            ...
            "options": {
                "A": "Debug comments can expose internal logic",
                "B": "They use special characters that break validation",
