  ...
  "questions": [
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "For <, >, &, and \" in content",
        "C": "Only when using old browsers",
        "D": "For all non-alphabet characters"
      },
      "correct": "B",
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>¥1,000 - ¥5,000</pre>",
        "B": "<pre>&amp;yen;1,000 &amp;ndash; &amp;yen;5,000</pre>",
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>&amp;quot;</pre> is larger",
        "B": "\" is only for programming",
        "C": "<pre>&amp;quot;</pre> works everywhere, \" may not in attributes",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "<pre>CoolProduct (TM)</pre>",
        "C": "<pre>CoolProduct&amp;trade;</pre>",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Never, always use entities",
        "C": "When line breaks at that point are acceptable",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "<pre>The file is &amp;lt; 1MB</pre>",
        "D": "<pre>The file is [less than] 1MB</pre>"
      },
      "correct": "C",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "It makes text italic",
        "C": "It's required for SEO",
        "D": "It works reliably in all contexts, including attributes"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "To comply with HTML validators only",
        "C": "To improve page loading speed",
        "D": "To ensure characters display correctly and avoid parsing errors"
      },
      "correct": "D",
