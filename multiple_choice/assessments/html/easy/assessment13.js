// assessment13.js - HTML Block vs Inline Elements
const metadata = {
...
const questions = [
    {
        ...
        "topic": {
            "topics": ["Block Elements", "Inline Elements", "Display Behavior"]
        }
    },
    {
        "id": 2,
        ...
        "topic": {
            "topics": ["Block Elements", "Display Behavior"]
        }
    },
    {
        "id": 3,
        ...
        "topic": {
            "topics": ["Block Elements", "Display Behavior", "Content Flow"]
        }
    },
    {
        "id": 4,
        ...
        "topic": {
            "topics": ["Inline Elements", "Text-level Semantics"]
        }
    },
    {
        "id": 5,
        ...
        "topic": {
            "topics": ["CSS Display Property", "Display Behavior"]
        }
    },
    {
        "id": 6,
        ...
        "topic": {
            "topics": ["Nesting Rules", "Block Elements", "Inline Elements"]
        }
    },
    {
        "id": 7,
    ...
    },
    {
        ...
        "options": {
            "A": "A generic block-level container for grouping content",
            "B": "Creating divisions in mathematical formulas",
        ...
        "topic": {
            "topics": ["Block Elements", "Layout Fundamentals"]
        }
    },
    {
        "id": 10,
    ...
    },
    {
        ...
        "options": {
            "A": "It starts behaving like a block element",
    ...
    },
    {
        ...
        "topic": {
            "topics": ["Block Elements", "Nesting Rules"]
        }
    },
    {
        "id": 13,
        ...
        "topic": {
            "topics": ["Inline Elements", "Display Behavior"]
        }
    },
    {
        "id": 14,
        ...
        "topic": {
            "topics": ["Semantic Block Elements", "Block Elements"]
        }
    },
    {
        "id": 15,
    ...
    },
    {
        ...
        "options": {
            "A": "<pre>strong</pre> has semantic importance, <pre>b</pre> is stylistic",
            "B": "<pre>strong</pre> is block-level, <pre>b</pre> is inline",
            "C": "<pre>strong</pre> is newer than <pre>b</pre>",
    ...
    },
    {
        ...
        "topic": {
            "topics": ["CSS Display Property", "Layout Fundamentals"]
        }
    },
    {
        "id": 19,
        ...
        "topic": {
            "topics": ["Inline Elements", "Element Categories"]
        }
    },
    {
        "id": 20,
    ...
    },
    {
        ...
        "options": {
            "A": "It's invalid HTML and may not render correctly",
            "B": "The block element becomes inline",
            "C": "The inline element becomes block-level",
        ...
        "topic": {
            "topics": ["Nesting Rules", "Element Categories"]
        }
    },
    {
        "id": 22,
        ...
        "topic": {
            "topics": ["Block Elements", "Semantic Block Elements"]
        }
    },
    {
        "id": 23,
    ...
    },
    {
        ...
        "options": {
            "A": "Makes the element's children act as direct children of its parent",
            "B": "Hides the element and its contents",
            "C": "Makes the element transparent",
            "D": "Creates a table-like display"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "options": {
            "A": "Better accessibility and SEO",
            "B": "Automatic styling",
            "C": "Smaller file size",
            "D": "Faster rendering"
        },
    ...
    },
    {
        ...
        "options": {
            "A": "<pre>display: grid;</pre>",
            "B": "<pre>display: flex;</pre>",
            "C": "<pre>display: block;</pre>",
            "D": "<pre>display: table;</pre>"
        },
        "correct": "A",
