  ...
  "questions": [
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "To convert HTML to other formats",
        "C": "To check HTML syntax and standards compliance",
    ...
    },
    {
      ...
      "options": {
        "A": "It prevents parsing errors with spaces in values",
        "B": "It makes HTML files smaller",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "JavaScript files won't load",
        "C": "CSS stops working entirely",
        "D": "Elements appear nested incorrectly"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "To ensure cross-browser compatibility",
        "B": "To guarantee perfect design",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "CSS property conflicts",
        "C": "Automatic validation failure",
        "D": "Harder to read and maintain code"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "<pre>title</pre> within <pre>head</pre>",
        "D": "<pre>html</pre>, <pre>head</pre>, and <pre>body</pre>"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "<pre><p><div>Content</div></p></pre>",
        "C": "<pre><a href=\"#\"><span>Link</span></a></pre>",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Smaller file size",
        "C": "Consistency with HTML element convention",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Warning for accessibility",
        "C": "Image won't display",
    ...
    },
    {
      ...
      "options": {
        "A": "Either tabs or spaces, but consistent",
        "B": "Spaces only",
        "C": "Tabs only",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Automatic voice control compatibility",
        "C": "Proper semantic structure for assistive technology",
    ...
    },
    {
      ...
      "options": {
        "A": "Missing closing </pre>div</pre> tag",
    ...
    },
    {
      ...
      "options": {
        ...
        "D": "Potential future browser incompatibility"
      },
      "correct": "D",
