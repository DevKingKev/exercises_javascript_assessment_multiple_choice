// assessment6.js - HTML Forms Deep Dive
const metadata = {
...
const questions = [
    ...
    },
    {
        ...
        "topic": {
            "topics": ["Form Validation", "Form Submission"]
        }
    },
    {
        "id": 4,
        ...
        "topic": {
            "topics": ["Input Attributes", "Form Validation"]
        }
    },
    {
        "id": 5,
        ...
        "topic": {
            "topics": ["Input Modes", "Form Accessibility"]
        }
    },
    {
        "id": 6,
        ...
        "topic": {
            "topics": ["Field Organization", "Form Accessibility"]
        }
    },
    {
        "id": 7,
    ...
    },
    {
        ...
        "options": {
            "A": "Associates a control with a form outside the form element",
            "B": "Defines the form action",
        ...
        "topic": {
            "topics": ["Form Organization", "Form Submission"]
        }
    },
    {
        "id": 10,
    ...
    },
    {
        ...
        "options": {
            "A": "The encoding type for form submission",
            "B": "The form encryption method",
    ...
    },
    {
        ...
        "options": {
            "A": "Specifies where to display form response",
            "B": "Sets form validation target",
            "C": "Defines form security target",
    ...
    },
    {
        ...
        "options": {
            "A": "Overrides the form's method attribute",
            "B": "Defines form validation method",
    ...
    },
    {
        ...
        "options": {
            "A": "Submits the text direction along with the value",
            "B": "Sets the input direction",
            "C": "Defines directory name for file inputs",
            "D": "Specifies form direction"
        },
        "correct": "A",
        ...
        "topic": {
            "topics": ["Input Attributes", "Form Submission"]
        }
    },
    {
        "id": 18,
        ...
        "topic": {
            "topics": ["Input Attributes", "Form Accessibility"]
        }
    },
    {
        "id": 19,
        ...
        "options": {
            "A": "The form's action attribute",
            "B": "Form validation action",
    ...
    },
    {
        ...
        "options": {
            "A": "Allows selecting multiple files",
            "B": "Creates multiple file fields",
            "C": "Enables multiple file validation",
        ...
        "topic": {
            "topics": ["Input Attributes", "Specialized Controls"]
        }
    },
    {
        "id": 22,
    ...
    },
    {
        ...
        "options": {
            "A": "Specifies how form data is encoded for submission",
            "B": "Sets form encryption type",
    ...
    },
    {
        ...
        "topic": {
            "topics": ["Form Security", "Form Submission"]
        }
    },
    {
        "id": 30,
        ...
        "options": {
            "A": "By default, but can be controlled with CSS",
            "B": "<pre>resizable</pre>",
            "C": "<pre>flexible</pre>",
            "D": "<pre>sizable</pre>"
        },
