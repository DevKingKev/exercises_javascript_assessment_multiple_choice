// assessment9.js - HTML Entities and Special Characters
const metadata = {
...
const questions = [
    {
        ...
        "topic": {
            "topics": ["HTML Entities", "Special Characters"]
        }
    },
    {
        "id": 2,
    ...
    },
    {
        ...
        "topic": {
            "topics": ["HTML Entities", "Whitespace Handling"]
        }
    },
    {
        "id": 4,
        ...
        "topic": {
            "topics": ["HTML Entities", "Copyright and Trademarks"]
        }
    },
    {
        "id": 5,
    ...
    },
    {
        ...
        "topic": {
            "topics": ["HTML Entities", "Currency Symbols"]
        }
    },
    {
        "id": 8,
    ...
    },
    {
        ...
        "correct": "A",
        "explanation": "The <pre>&amp;times;</pre> entity represents the multiplication sign (×). This is different from the letter 'x' and is used in mathematical expressions. Example: <pre>5 &amp;times; 3 = 15</pre> displays as 5 × 3 = 15.",
        "topic": {
            "topics": ["HTML Entities", "Mathematical Symbols"]
        }
    },
    {
        "id": 10,
    ...
    },
    {
        ...
        "topic": {
            "topics": ["HTML Entities", "Character References"]
        }
    },
    {
        "id": 17,
        ...
        "options": {
            "A": "To prevent line breaks between words",
            "B": "To create extra spacing between paragraphs",
            "C": "To indent the first line of a paragraph",
    ...
    },
    {
        ...
        "topic": {
            "topics": ["HTML Entities", "Symbols and Icons"]
        }
    },
    {
        "id": 19,
    ...
    },
    {
        ...
        "correct": "A",
        "explanation": "The <pre>&amp;bull;</pre> entity produces the bullet point symbol (•). This can be used to create custom list markers or separate items inline. Example: <pre>Item &amp;bull; Item</pre> displays as Item • Item.",
        "topic": {
            "topics": ["HTML Entities", "Symbols and Icons"]
        }
    },
    ...
    },
    {
        ...
        "correct": "A",
        "explanation": "The <pre>&amp;mdash;</pre> entity represents the em dash (—), which is a long dash used for punctuation, similar to parentheses or colons. The shorter en dash is <pre>&amp;ndash;</pre> (–).",
        "topic": {
            "topics": ["HTML Entities", "Special Characters"]
        }
    },
    {
        ...
        "options": {
            "A": "To prevent unwanted line breaks",
            "B": "To create wider spacing",
            "C": "To improve SEO",
            "D": "To make text bold"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "options": {
            "A": "For characters <, >, &, and \" in content",
            "B": "For all non-alphanumeric characters",
            "C": "Only when using ASCII encoding",
