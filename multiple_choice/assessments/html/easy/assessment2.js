module.exports = {
  ...
  "questions": [
    ...
    },
    {
      ...
      "options": {
        "A": "Radio buttons are round; checkboxes are square (visual only)",
        "B": "Radio buttons allow selecting only one option; checkboxes allow multiple",
    ...
    },
    {
      ...
      "options": {
        "A": "Sets the default value",
        "B": "Displays hint text that disappears when user types",
        "C": "Creates a label",
    ...
    },
    {
      ...
      "options": {
        "A": "The visible label text",
        "B": "The key used when submitting the form data",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "The HTTP method used to submit form data",
    ...
    },
    {
      ...
      "options": {
        "A": "Creates a password field",
        "B": "Hides the input until clicked",
        "C": "Encrypts the value",
        "D": "Submits data invisibly without displaying it to users"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "D": "Resets all form fields to their initial values"
      },
      "correct": "D",
