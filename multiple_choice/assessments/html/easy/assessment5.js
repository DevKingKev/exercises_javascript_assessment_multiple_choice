module.exports = {
  ...
  "questions": [
    ...
    },
    {
      ...
      "options": {
        "A": "Creates a word break",
        "B": "Suggests a possible line-break opportunity",
    ...
    },
    {
      ...
      "options": {
        "A": "<pre><meta name=\"summary\" content=\"Page summary\"></pre>",
        "B": "<pre><meta name=\"description\" content=\"Page description\"></pre>",
    ...
    },
    {
      ...
      "options": {
        "A": "Measures page loading time",
        "B": "Represents a scalar measurement within a known range",
    ...
    },
    {
      ...
      "options": {
        "A": "Defines CSS template styles",
        "B": "Creates a template for the entire page",
        "C": "Holds HTML content that can be cloned and inserted later",
    ...
    },
    {
      ...
      "options": {
        ...
        "D": "The result of a calculation or user action"
      },
      "correct": "D",
