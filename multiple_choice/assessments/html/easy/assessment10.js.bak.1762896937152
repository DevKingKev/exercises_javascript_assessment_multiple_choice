// assessment10.js - HTML Entities and Special Characters Advanced
const metadata = {
...
const questions = [
    {
        ...
        "topic": {
            "topics": ["Reserved Characters", "Entity Syntax"]
        }
    },
    {
        "id": 2,
        ...
        "topic": {
            "topics": ["Whitespace Entities", "Entity Best Practices"]
        }
    },
    {
        "id": 3,
    ...
    },
    {
        ...
        "topic": {
            "topics": ["Currency Entities", "Mathematical Entities"]
        }
    },
    {
        "id": 5,
        ...
        "topic": {
            "topics": ["Legal Symbols", "Entity Best Practices"]
        }
    },
    {
        "id": 6,
        ...
        "topic": {
            "topics": ["Mathematical Entities", "Symbol Usage"]
        }
    },
    {
        "id": 7,
    ...
    },
    {
        ...
        "topic": {
            "topics": ["Symbol Usage", "Mathematical Entities"]
        }
    },
    {
        "id": 9,
        ...
        "topic": {
            "topics": ["Punctuation Entities", "Reserved Characters"]
        }
    },
    {
        "id": 10,
        ...
        "topic": {
            "topics": ["Currency Entities", "Punctuation Entities"]
        }
    },
    {
        "id": 11,
        ...
        "topic": {
            "topics": ["Reserved Characters", "Entity Best Practices"]
        }
    },
    {
        "id": 12,
        ...
        "options": {
            "A": "<pre>SuperProduct&amp;reg;</pre>",
            "B": "<pre>SuperProduct&reg;</pre>",
            "C": "<pre>SuperProduct (R)</pre>",
            "D": "<pre>SuperProduct&registered;</pre>"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "options": {
            "A": "Prevents 'ABC' and 'Inc.' from separating",
            "B": "Makes the name bold",
    ...
    },
    {
        ...
        "options": {
            "A": "<pre>&amp;quot;</pre> works everywhere, \" may not in attributes",
            "B": "<pre>&amp;quot;</pre> is larger",
    ...
    },
    {
        ...
        "options": {
            "A": "<pre>10 &amp;times; 15 cm</pre>",
            "B": "<pre>10 x 15 cm</pre>",
            "C": "<pre>10 by 15 cm</pre>",
            "D": "<pre>10*15 cm</pre>"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "options": {
            "A": "When line breaks at that point are acceptable",
            "B": "Only in programming code",
    ...
    },
    {
        ...
        "options": {
            "A": "<pre>The file is &amp;lt; 1MB</pre>",
            "B": "<pre>The file is < 1MB</pre>",
            "C": "<pre>The file is [less than] 1MB</pre>",
            "D": "<pre>The file is smaller than 1MB</pre>"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "options": {
            "A": "<pre>&amp;pound;25 per item</pre>",
            "B": "<pre>GBP 25 per item</pre>",
            "C": "<pre>25 pounds per item</pre>",
        ...
        "topic": {
            "topics": ["Currency Entities", "Symbol Usage"]
        }
    },
    {
        "id": 24,
        ...
        "options": {
            "A": "It works reliably in all contexts, including attributes",
            "B": "It looks more curved",
        ...
        "topic": {
            "topics": ["Punctuation Entities", "Entity Best Practices"]
        }
    },
    {
        "id": 25,
    ...
    },
    {
        ...
        "options": {
            "A": "<pre>2 &amp;times; 4 &amp;times; 6 inches</pre>",
            "B": "<pre>2 x 4 x 6 inches</pre>",
            "C": "<pre>2 by 4 by 6 inches</pre>",
            "D": "<pre>2*4*6 inches</pre>"
        },
        "correct": "A",
    ...
    },
    {
        ...
        "options": {
            "A": "Three non-breaking spaces in a row",
        ...
        "topic": {
            "topics": ["Whitespace Entities", "Entity Syntax"]
        }
    },
    {
        "id": 28,
    ...
    },
    {
        ...
        "options": {
            "A": "To ensure characters display correctly and avoid parsing errors",
        ...
        "topic": {
            "topics": ["Entity Best Practices", "Character Display"]
        }
    }
];
