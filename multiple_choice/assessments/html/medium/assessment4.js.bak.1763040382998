module.exports = {
    ...
    "questions": [
        ...
        },
        {
            ...
            "topic": {
                "topics": ["Accessibility", "Semantic HTML"]
            }
        },
        {
            "id": 3,
        ...
        },
        {
            ...
            "options": {
                ...
                "C": "Output values are included in form submission",
                "D": "Output provides better visual styling"
            },
            "correct": "D",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "Use progress for ongoing processes, meter for measured values",
                "C": "Use meter for uploads, progress for downloads",
                "D": "They are interchangeable for file uploads"
            },
            "correct": "B",
        ...
        },
        {
            ...
            "topic": {
                "topics": ["Advanced Form Controls", "Browser Compatibility"]
            }
        },
        {
            "id": 7,
            ...
            "options": {
                ...
                "B": "The form uses the method from the first button",
                "C": "The browser shows a validation error",
                "D": "All buttons default to the form's method attribute"
            },
            "correct": "D",
        ...
        },
        {
            ...
            "options": {
                "A": "Use JavaScript to detect support and polyfill",
                "B": "Provide a separate select element as alternative",
            ...
            "topic": {
                "topics": ["Progressive Enhancement", "Browser Compatibility"]
            }
        },
        {
            "id": 9,
        ...
        },
        {
            ...
            "topic": {
                "topics": ["Accessibility", "Advanced Form Controls"]
            }
        },
        {
            "id": 11,
            ...
            "options": {
                "A": "The form submits to the custom URL without validation",
                "B": "Only formaction works, formnovalidate is ignored",
            ...
            "topic": {
                "topics": ["Advanced Form Controls", "Form Validation"]
            }
        },
        {
            "id": 12,
        ...
        },
        {
            ...
            "options": {
                "A": "Use legend to describe the radio group purpose",
                "B": "Add role=\"radiogroup\" to the fieldset",
                "C": "Place each radio in its own fieldset",
        ...
        },
        {
            ...
            "options": {
                ...
                "C": "The page throws a JavaScript error",
                "D": "The input uses the nearest parent form"
            },
            "correct": "C",
        ...
        },
        {
            ...
            "options": {
                "A": "It closes the form's parent dialog without submitting",
                "B": "It submits the form via AJAX instead of page reload",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "It associates the output with form labels",
                "C": "It specifies which inputs contribute to the output",
                "D": "Output elements don't have a labels property"
            },
            "correct": "D",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "Change the value property directly",
                "C": "Use the updateProgress method",
        ...
        },
        {
            ...
            "options": {
                "A": "It provides semantic structure and built-in accessibility",
                "B": "It automatically applies CSS styles to grouped elements",
                "C": "It improves form submission performance",
                "D": "It enables client-side validation for the group"
            },
            "correct": "A",
        ...
        },
        {
            ...
            "options": {
                "A": "It associates the input with the form's validation rules",
                "B": "It enables cross-form validation",
                "C": "It has no effect on validation",
                "D": "It disables validation for that input"
            },
            "correct": "A",
        ...
        },
        {
            ...
            "options": {
                "A": "It resolves relative to the current page URL",
                "B": "It resolves relative to the form's action URL",
                "C": "The browser converts it to absolute URL",
        ...
        },
        {
            ...
            "options": {
                "A": "Place each step's inputs outside forms with same form ID",
                "B": "Use multiple forms with the same name attribute",
                "C": "Create separate forms and combine data with JavaScript",
                "D": "Use fieldset for each step with form attribute"
            },
            "correct": "D",
        ...
        },
        {
            ...
            "options": {
                "A": "It includes the output value in form submission data",
                "B": "It provides an identifier for the output element",
        ...
        },
        {
            ...
            "options": {
                "A": "Provide a fallback text showing percentage",
                "B": "Use JavaScript to create animated divs",
                "C": "Hide progress in unsupported browsers",
                "D": "Use meter as fallback for progress"
            },
            "correct": "A",
