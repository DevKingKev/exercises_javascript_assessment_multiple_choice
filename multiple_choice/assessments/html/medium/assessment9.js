  ...
  "questions": [
    {
      ...
      "options": {
        "A": "<pre>navigator.position.get()</pre>",
        "B": "<pre>navigator.location.getLocation(success)</pre>",
        "C": "<pre>window.getPosition()</pre>",
        "D": "<pre>navigator.geolocation.getCurrentPosition(success, error)</pre>"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "<pre>IndexedDB only</pre>",
        "C": "<pre>sessionStorage</pre>",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "<pre>localStorage.state</pre>",
        "D": "<pre>document.write(localStorage.getItem('state'))</pre>"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>Disables spellchecking for the element</pre>",
        "B": "<pre>Makes the element draggable</pre>",
        "C": "<pre>Makes the element's contents editable by the user</pre>",
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>event.dataTransfer.read()</pre>",
        "B": "<pre>event.dataTransfer.getData('text/plain')</pre>",
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>Save session tokens in localStorage</pre>",
        "B": "<pre>Store only non-sensitive, serialized preference objects</pre>",
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>draggable=\"true\" spellcheck=\"false\"</pre>",
        "B": "<pre>contenteditable=\"false\" spellcheck=\"true\"</pre>",
        "C": "<pre>translate=\"no\" spellcheck=\"true\"</pre>",
        "D": "<pre>contenteditable=\"true\" spellcheck=\"false\"</pre>"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "<pre>navigator.position.watch()</pre>",
        "C": "<pre>navigator.geolocation.track()</pre>",
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>sessionStorage</pre>",
        "B": "<pre>localStorage</pre>",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "<pre>spellcheck=\"false\" translate=\"yes\"</pre>",
        "C": "<pre>contenteditable=\"false\" translate=\"yes\"</pre>",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "<pre>spellcheck=\"0\"</pre>",
        "C": "<pre>spellcheck=\"off\"</pre>",
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>Rely solely on mouse-driven drag gestures</pre>",
        "B": "<pre>Also provide keyboard controls and ARIA live announcements</pre>",
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>Use window.name for persistent shared state</pre>",
        "B": "<pre>Use sessionStorage for cross-tab sync</pre>",
        "C": "<pre>Use localStorage and the storage event for cross-tab updates</pre>",
