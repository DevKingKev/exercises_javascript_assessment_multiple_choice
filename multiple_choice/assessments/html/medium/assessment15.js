module.exports = {
  "metadata": {
    ...
    "topicLinks": [
      {
        "topicName": "lang Attribute",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/lang"
      },
      {
        "topicName": "dir Attribute and Text Direction",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/dir"
      },
      {
        "topicName": "Bidirectional Override (bdo)",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/HTML/Element/bdo"
      },
      {
        "topicName": "Bidirectional Isolation (bdi)",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/HTML/Element/bdi"
      },
      {
        "topicName": "translate Attribute",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/translate"
      },
      {
        "topicName": "Character Encoding",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/HTML/Element/meta#attr-charset"
      },
      {
        "topicName": "Right-to-Left (RTL) Layout",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Logical_Properties"
      },
      {
        "topicName": "Language Tags and Best Practices",
        "refLink": "https://www.w3.org/International/questions/qa-html-language-declarations"
      }
    ],
    "assessmentId": 15,
  ...
  "questions": [
    ...
    },
    {
      ...
      "options": {
        "A": "Create separate HTML documents for each language",
        "B": "Only set the <pre>lang</pre> attribute once on the <pre><html></pre> element",
        "C": "Set <pre>lang</pre> on <pre><html></pre> for the primary language, then override with <pre>lang</pre> attributes on elements containing other languages",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Content that's already been translated",
        "C": "Proper names, brand names, code examples, technical identifiers, and other content that should remain unchanged when translating",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "An encryption system for international text",
        "C": "A method for translating between Unicode and ASCII",
        "D": "An algorithm that determines how bidirectional text (mixing LTR and RTL) should be displayed"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "It's optional and generally discouraged for UTF-8; it can cause issues with some tools and isn't necessary for UTF-8",
        "B": "It's required for all UTF-8 files",
