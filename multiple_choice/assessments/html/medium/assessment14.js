module.exports = {
  ...
  "questions": [
    ...
    },
    {
      ...
      "options": {
        "A": "The server generates a unique random value per page load, includes it in the CSP header, and adds matching nonce attributes to approved inline scripts",
        "B": "It allows scripts to execute only once",
        "C": "It encrypts all scripts with a nonce key",
        "D": "It generates random numbers for each resource request"
      },
      "correct": "A",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "It creates hashtags for social media sharing",
        "C": "It compresses scripts using hash algorithms",
        "D": "It allows specific inline scripts by whitelisting their cryptographic hash in the CSP policy"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "All JavaScript execution including external scripts, inline scripts, eval(), and inline event handlers",
        "B": "Only inline JavaScript code",
        "C": "Only external JavaScript files from <pre><script src></pre> tags",
    ...
    },
    {
      ...
      "options": {
        "A": "Visual styling preferences for the browser",
        "B": "Only CSS files loaded via <pre><link></pre> tags",
        "C": "CSS preprocessor settings",
        "D": "All CSS sources including external stylesheets, inline <pre><style></pre> blocks, and inline style attributes"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "D": "Yes, list them separated by spaces: <pre>script-src 'self' https://cdn.example.com https://analytics.example.com</pre>"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "HTTP headers are more secure and support all CSP features; meta tags can't use some directives like frame-ancestors or report-uri",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "Add the full URL including protocol: <pre>script-src https://example.com</pre>",
        "D": "Use <pre>script-src allow:https://example.com</pre>"
      },
      "correct": "C",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Meta tags don't support frame-related directives",
        "C": "It needs to be processed before the page is parsed, which happens before meta tags are read",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "URLs that can be loaded using fetch(), XMLHttpRequest, WebSocket, EventSource, and similar APIs",
    ...
    },
    {
      ...
      "options": {
        ...
        "undefined": "Start with a strict policy like default-src 'none', add only what's needed, test with report-only mode first, then enforce"
      },
