module.exports = {
    metadata: {
        ...
        topicLinks: [
            { topicName: "CSP Meta Tag Syntax", refLink: "https://developer.mozilla.org/en-US/docs/Web/HTTP/CSP" },
            { topicName: "default-src Directive", refLink: "https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Content-Security-Policy/default-src" },
            { topicName: "script-src Directive", refLink: "https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Content-Security-Policy/script-src" },
            { topicName: "style-src Directive", refLink: "https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Content-Security-Policy/style-src" },
            { topicName: "Nonce-based CSP", refLink: "https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Content-Security-Policy/Sources#sources" },
            { topicName: "Hash-based CSP", refLink: "https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Content-Security-Policy/Sources#sources" },
            { topicName: "CSP Security Benefits", refLink: "https://developer.mozilla.org/en-US/docs/Web/HTTP/CSP" },
            { topicName: "Common CSP Configurations", refLink: "https://content-security-policy.com/" }
        ],
        assessmentId: 14,
    ...
    questions: [
        {
            ...
            options: {
                A: "To improve website performance by optimizing resource loading",
                B: "To protect against Cross-Site Scripting (XSS) and other code injection attacks by controlling which resources can be loaded",
...

        {
            ...
            options: {
                A: "<pre><meta name=\"csp\" content=\"default-src 'self'\"></pre>",
                B: "<pre><meta http-equiv=\"Content-Security-Policy\" content=\"default-src 'self'\"></pre>",
...

        {
            ...
            options: {
                ...
                B: "It serves as a fallback for all fetch directives that aren't explicitly specified",
                C: "It defines the default script source only",
                D: "It enables CSP in default mode with recommended settings"
            },
            correct: "B",
            ...
            topics: ["default-src Directive", "Common CSP Configurations"]
        },

        {
            ...
            options: {
                A: "Scripts can only be loaded from the same origin (same protocol, domain, and port)",
                B: "Scripts can be loaded from any HTTPS source",
            ...
            topics: ["script-src Directive", "Common CSP Configurations"]
        },

        {
            ...
            options: {
                ...
                B: "It allows inline scripts and styles, which defeats the main XSS protection that CSP provides",
                C: "It enables deprecated HTML features",
                D: "It allows loading resources over HTTP instead of HTTPS"
            },
            correct: "B",
            ...
            topics: ["script-src Directive", "CSP Security Benefits"]
        },

        {
            ...
            options: {
                ...
                B: "The server generates a unique random value per page load, includes it in the CSP header, and adds matching nonce attributes to approved inline scripts",
                C: "It encrypts all scripts with a nonce key",
                D: "It allows scripts to execute only once"
            },
            correct: "B",
            ...
            topics: ["Nonce-based CSP", "script-src Directive"]
        },

        {
            ...
            topics: ["Hash-based CSP", "script-src Directive"]
        },

        {
            ...
            options: {
                ...
                B: "All JavaScript execution including external scripts, inline scripts, eval(), and inline event handlers",
                C: "Only inline JavaScript code",
...

        {
            ...
            options: {
                A: "Only CSS files loaded via <pre><link></pre> tags",
                B: "All CSS sources including external stylesheets, inline <pre><style></pre> blocks, and inline style attributes",
...

        {
            ...
            options: {
                ...
                B: "The browser blocks the resource from loading and logs a violation to the console",
                C: "The resource is loaded from a fallback CDN",
            ...
            topics: ["CSP Security Benefits", "Common CSP Configurations"]
        },

        {
            ...
            options: {
                ...
                B: "Yes, list them separated by spaces: <pre>script-src 'self' https://cdn.example.com https://analytics.example.com</pre>",
                C: "Yes, but only two sources maximum",
            ...
            topics: ["Common CSP Configurations", "script-src Directive"]
        },

        {
            ...
            options: {
                ...
                B: "HTTP headers are more secure and support all CSP features; meta tags can't use some directives like frame-ancestors or report-uri",
                C: "Meta tags are faster and more efficient",
                D: "HTTP headers only work on servers, while meta tags work everywhere"
            },
            correct: "B",
            ...
            topics: ["CSP Meta Tag Syntax", "CSP Security Benefits"]
        },
...

        {
            ...
            options: {
                ...
                B: "Add the full URL including protocol: <pre>script-src https://example.com</pre>",
                C: "Use <pre>script-src allow:https://example.com</pre>",
                D: "Use <pre>script-src domain=\"example.com\"</pre>"
            },
            correct: "B",
...

        {
            ...
            topics: ["Common CSP Configurations", "default-src Directive"]
        },

        {
            ...
            options: {
                A: "Only <pre><img></pre> tag sources",
                B: "All image sources including <pre><img></pre>, CSS background-image, favicons, and other image contexts",
            ...
            topics: ["Common CSP Configurations"]
        },

        {
            ...
            options: {
                ...
                B: "Generate a cryptographically random value that's unique for each page load",
                C: "Use the current timestamp",
                D: "Use the user's session ID"
            },
            correct: "B",
            ...
            topics: ["Nonce-based CSP", "CSP Security Benefits"]
        },

        {
            ...
            options: {
                ...
                B: "To specify a URL where the browser should send CSP violation reports",
                C: "To redirect users when CSP violations occur",
            ...
            topics: ["Common CSP Configurations", "CSP Security Benefits"]
        },

        {
            ...
            options: {
                ...
                B: "It doesn't enforce CSP but reports violations, allowing you to test policies without breaking functionality",
                C: "It only protects against reporting-related attacks",
...

        {
            ...
            topics: ["Nonce-based CSP", "Hash-based CSP", "script-src Directive"]
        },

        {
            ...
            options: {
                A: "It upgrades the CSP policy to the latest version",
                B: "It automatically upgrades HTTP requests to HTTPS when loading resources",
