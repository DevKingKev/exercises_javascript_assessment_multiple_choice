  ...
  "questions": [
    {
      ...
      "options": {
        "A": "To provide semantic grouping of table content and enable features like fixed headers and footers when scrolling",
    ...
    },
    {
      ...
      "options": {
        "A": "It specifies whether the header applies to a row, column, row group, or column group for accessibility",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "It causes a validation error; colspan must be a positive integer",
        "C": "The cell spans from its position to the end of the current column group",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Either <pre><thead></pre>, <pre><tbody></pre>, <pre><tfoot></pre> or <pre><thead></pre>, <pre><tfoot></pre>, <pre><tbody></pre> are valid",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Only <pre>width</pre> can be applied; all other properties are ignored",
        "C": "Only <pre>background</pre>, <pre>border</pre>, <pre>width</pre>, and <pre>visibility</pre> are reliably supported",
    ...
    },
    {
      ...
      "options": {
        ...
        "D": "<pre><td rowspan=\"2\" colspan=\"3\"></pre>"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "It specifies the number of consecutive columns the column group represents",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Only when the table has more than 100 rows for performance reasons",
        "C": "When you want to logically group related rows, such as separating data by category or applying borders between groups",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Add <pre>class=\"odd\"</pre> or <pre>class=\"even\"</pre> manually; CSS can't target tbody elements",
        "C": "Use <pre>tbody:nth-of-type(odd)</pre> and <pre>tbody:nth-of-type(even)</pre> CSS selectors",
    ...
    },
    {
      ...
      "options": {
        ...
        "D": "Screen readers announce table structure (rows, columns, headers), confusing users when the content isn't actually tabular data"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "D": "Omit the cell at that column position in the next 2 rows, as the spanning cell already occupies that space"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "D": "<pre><th></pre> for header cells (labels), <pre><td></pre> for data cells (values)"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "It positions the caption above (<pre>top</pre>) or below (<pre>bottom</pre>) the table",
    ...
    },
    {
      ...
      "options": {
        "A": "No scope attributes needed; the table structure is self-explanatory",
        "B": "All headers should use <pre>scope=\"rowgroup\"</pre>",
        "C": "Time headers with <pre>scope=\"col\"</pre>, day headers with <pre>scope=\"row\"</pre>",
        "D": "Time headers with <pre>scope=\"row\"</pre>, day headers with <pre>scope=\"col\"</pre>"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "D": "Use a <pre><caption></pre> element with descriptive text, or use <pre>aria-describedby</pre> referencing an element with the description"
      },
      "correct": "D",
