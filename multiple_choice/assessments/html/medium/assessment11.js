module.exports = {
    metadata: {
        ...
        topicLinks: [
            { topicName: "Table Structure (thead, tbody, tfoot)", refLink: "https://developer.mozilla.org/en-US/docs/Web/HTML/Element/table" },
            { topicName: "Cell Spanning (colspan, rowspan)", refLink: "https://developer.mozilla.org/en-US/docs/Web/HTML/Element/td#colspan" },
            { topicName: "Column Styling (colgroup, col)", refLink: "https://developer.mozilla.org/en-US/docs/Web/HTML/Element/colgroup" },
            { topicName: "Table Accessibility", refLink: "https://developer.mozilla.org/en-US/docs/Learn/HTML/Tables/Advanced" },
            { topicName: "scope Attribute", refLink: "https://developer.mozilla.org/en-US/docs/Web/HTML/Element/th#scope" },
            { topicName: "Table Captions", refLink: "https://developer.mozilla.org/en-US/docs/Web/HTML/Element/caption" },
            { topicName: "Complex Table Layouts", refLink: "https://developer.mozilla.org/en-US/docs/Learn/HTML/Tables" },
            { topicName: "Semantic Table Markup", refLink: "https://developer.mozilla.org/en-US/docs/Web/HTML/Element/table" }
        ],
        assessmentId: 11,
    ...
    questions: [
        {
            ...
            options: {
                A: "To enable automatic pagination of long tables",
                B: "To provide semantic grouping of table content and enable features like fixed headers and footers when scrolling",
                C: "To apply different CSS styles automatically based on row position",
                D: "To improve page load performance by lazy-loading table sections"
            },
            correct: "B",
            ...
            topics: ["Table Structure (thead, tbody, tfoot)"]
        },

        {
            ...
            topics: ["Cell Spanning (colspan, rowspan)"]
        },

        {
            ...
            options: {
                A: "It defines which CSS styles should apply to the header cell",
                B: "It specifies whether the header applies to a row, column, row group, or column group for accessibility",
                C: "It limits the number of data cells that can appear under that header",
            ...
            topics: ["scope Attribute", "Table Accessibility"]
        },
...

        {
            ...
            options: {
                A: "To define column-specific attributes and styling without adding classes to individual cells",
                B: "To enable automatic column sorting functionality",
                C: "To create responsive columns that collapse on mobile devices",
                D: "To enforce data validation rules for table columns"
            },
            correct: "A",
            ...
            topics: ["Column Styling (colgroup, col)"]
        },

        {
            ...
            options: {
                ...
                B: "As the first child of the <pre><table></pre> element; it provides a visible title and context for the table",
                C: "Inside <pre><thead></pre>; it labels the header section specifically",
                D: "After <pre><tfoot></pre>; it provides summary statistics for the table data"
            },
            correct: "B",
            ...
            topics: ["Table Captions", "Table Accessibility"]
        },

        {
            ...
            topics: ["Table Accessibility", "scope Attribute"]
        },

        {
            ...
            topics: ["Cell Spanning (colspan, rowspan)", "Complex Table Layouts"]
        },

        {
            ...
            options: {
                ...
                B: "The order must be <pre><thead></pre>, <pre><tfoot></pre>, <pre><tbody></pre>",
                C: "The order can be any sequence; the browser will render them correctly",
                D: "Either <pre><thead></pre>, <pre><tbody></pre>, <pre><tfoot></pre> or <pre><thead></pre>, <pre><tfoot></pre>, <pre><tbody></pre> are valid"
            },
            correct: "D",
            ...
            topics: ["Table Structure (thead, tbody, tfoot)", "Semantic Table Markup"]
        },
...

        {
            ...
            options: {
                ...
                B: "<pre><td rowspan=\"2\" colspan=\"3\"></pre>",
                C: "<pre><td rows=\"2\" cols=\"3\"></pre>",
                D: "<pre><td span-row=\"2\" span-col=\"3\"></pre>"
            },
            correct: "B",
...

        {
            ...
            topics: ["Table Accessibility", "Complex Table Layouts"]
        },

        {
            ...
            options: {
                ...
                B: "It specifies the number of consecutive columns the column group represents",
                C: "It sets the width of each column in pixels",
                D: "It determines how many cells can be merged in that column group"
            },
            correct: "B",
...

        {
            ...
            topics: ["Table Structure (thead, tbody, tfoot)", "Complex Table Layouts"]
        },

        {
            ...
            options: {
                ...
                B: "Screen readers announce table structure (rows, columns, headers), confusing users when the content isn't actually tabular data",
                C: "Layout tables cannot be styled with CSS",
                D: "Tables for layout cause the page to fail HTML validation"
            },
            correct: "B",
            ...
            topics: ["Table Accessibility", "Semantic Table Markup"]
        },

        {
            ...
            options: {
                A: "Add empty cells with <pre><td></td></pre> in subsequent rows at that column position",
                B: "Omit the cell at that column position in the next 2 rows, as the spanning cell already occupies that space",
                C: "Add <pre>rowspan=\"0\"</pre> to cells in subsequent rows at that column",
                D: "Nothing special; the browser automatically handles cell positioning"
            },
            correct: "B",
...

        {
            ...
            options: {
                A: "<pre><th></pre> for bold text, <pre><td></pre> for normal text",
                B: "<pre><th></pre> for header cells (labels), <pre><td></pre> for data cells (values)",
                C: "<pre><th></pre> only in <pre><thead></pre>, <pre><td></pre> only in <pre><tbody></pre>",
                D: "<pre><th></pre> for the first row and column, <pre><td></pre> for all other cells"
            },
            correct: "B",
            ...
            topics: ["Semantic Table Markup", "Table Accessibility"]
        },

        {
            ...
            options: {
                A: "It controls whether the caption is visible or hidden",
                B: "It positions the caption above (<pre>top</pre>) or below (<pre>bottom</pre>) the table",
                C: "It aligns caption text to left, center, or right",
                D: "It determines the caption's font size relative to the table"
            },
            correct: "B",
...

        {
            ...
            options: {
                ...
                B: "To apply the same background color or styling to a group of consecutive columns",
                C: "To make columns sortable",
                D: "To create column dividers or borders"
            },
            correct: "B",
...

        {
            ...
            topics: ["Column Styling (colgroup, col)", "Semantic Table Markup"]
        },
...

        {
            ...
            options: {
                ...
                B: "Use a <pre><caption></pre> element with descriptive text, or use <pre>aria-describedby</pre> referencing an element with the description",
                C: "Add a <pre>title</pre> attribute to the <pre><table></pre> element",
                D: "Include a <pre><div></pre> with the description directly before the table"
            },
            correct: "B",
            ...
            topics: ["Table Accessibility", "Table Captions"]
        }
    ]
};
