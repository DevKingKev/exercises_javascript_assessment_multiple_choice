module.exports = {
    metadata: {
        ...
        topicLinks: [
            { topicName: "hreflang Attribute", refLink: "https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/rel#attr-alternate" },
            { topicName: "Content Negotiation", refLink: "https://developer.mozilla.org/en-US/docs/Web/HTTP/Content_negotiation" },
            { topicName: "Locale-Specific Formatting", refLink: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl" },
            { topicName: "Multi-Language Navigation", refLink: "https://www.w3.org/International/questions/qa-site-conneg" },
            { topicName: "Cultural Considerations", refLink: "https://www.w3.org/International/techniques/authoring-html" },
            { topicName: "Number and Currency Formatting", refLink: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/NumberFormat" },
            { topicName: "Date and Time Localization", refLink: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/DateTimeFormat" },
            { topicName: "Text Collation and Sorting", refLink: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/Collator" },
            { topicName: "Language Switchers", refLink: "https://www.w3.org/International/questions/qa-navigation-select" },
            { topicName: "Internationalization Testing", refLink: "https://www.w3.org/International/i18n-drafts/techniques/authoring-html" }
        ],
        assessmentId: 16,
    ...
    questions: [
        {
            ...
            topics: ["hreflang Attribute", "Multi-Language Navigation"]
        },

        {
            ...
            options: {
                ...
                B: "Create semantic navigation with links to each language version, using <pre>hreflang</pre> and indicating the current language",
                C: "Use a dropdown menu without any semantic markup",
                D: "Rely entirely on automatic browser translation"
            },
            correct: "B",
            ...
            topics: ["Language Switchers", "Multi-Language Navigation", "hreflang Attribute"]
        },

        {
            ...
            options: {
                A: "A pricing negotiation system for international sales",
                B: "A mechanism where the server selects the best language/format for a resource based on headers like <pre>Accept-Language</pre> sent by the browser",
            ...
            topics: ["Content Negotiation", "Multi-Language Navigation"]
        },

        {
            ...
            topics: ["Language Switchers", "Cultural Considerations"]
        },

        {
            ...
            options: {
                ...
                B: "Messages must be translated, use appropriate locale formatting for dates/numbers, and maintain the same <pre>lang</pre> attribute as the form content",
                C: "Only translate the submit button",
            ...
            topics: ["Locale-Specific Formatting", "Cultural Considerations", "Multi-Language Navigation"]
        },

        {
            ...
            options: {
                ...
                B: "Different locales use different conventions: some use periods for thousands and commas for decimals (1.234.567,89), others the reverse (1,234,567.89)",
                C: "Numbers format the same way universally",
                D: "Only currency needs locale-specific formatting"
            },
            correct: "B",
            ...
            topics: ["Number and Currency Formatting", "Locale-Specific Formatting"]
        },

        {
            ...
            options: {
                ...
                B: "Use semantic markup with currency codes and locale-appropriate formatting, potentially with <pre>data-*</pre> attributes for machine-readable values",
                C: "Always convert everything to USD",
...

        {
            ...
            options: {
                A: "Dates format identically worldwide",
                B: "Date component order varies (MM/DD/YYYY vs DD/MM/YYYY vs YYYY-MM-DD), separators differ, and week start days vary by culture",
            ...
            topics: ["Date and Time Localization", "Locale-Specific Formatting"]
        },

        {
            ...
            options: {
                A: "To set the server time zone",
                B: "To provide a machine-readable date/time in the <pre>datetime</pre> attribute while displaying a human-readable, locale-appropriate format",
...

        {
            ...
            topics: ["Text Collation and Sorting", "Cultural Considerations"]
        },

        {
            ...
            topics: ["Multi-Language Navigation", "hreflang Attribute"]
        },

        {
            ...
            topics: ["Cultural Considerations", "Multi-Language Navigation"]
        },

        {
            ...
            options: {
                ...
                B: "Allow mixed-language content, use <pre>lang</pre> attributes when language is known, and consider <pre>dir=\"auto\"</pre> for unpredictable text direction",
                C: "Automatically translate all user content",
                D: "Separate users by language completely"
            },
            correct: "B",
            ...
            topics: ["Multi-Language Navigation", "Cultural Considerations", "Content Negotiation"]
        },

        {
            ...
            options: {
                ...
                B: "It specifies a default or fallback page for users whose language isn't explicitly targeted, often a language selector page",
                C: "It indicates experimental content",
                D: "It's used for XML documents only"
            },
            correct: "B",
...

        {
            ...
            topics: ["Internationalization Testing", "Cultural Considerations"]
        },

        {
            ...
            topics: ["Language Switchers", "Multi-Language Navigation"]
        },

        {
            ...
            topics: ["Locale-Specific Formatting", "Cultural Considerations"]
        },
...

        {
            ...
            options: {
                A: "Search works identically across all languages",
                B: "Challenges include language-specific tokenization, stemming, diacritics, ideographic languages, and providing relevant results across translations",
            ...
            topics: ["Text Collation and Sorting", "Multi-Language Navigation", "Cultural Considerations"]
        },

        {
            ...
            options: {
                ...
                B: "To inform the server about the user's preferred languages in priority order, enabling content negotiation",
                C: "To set the programming language for scripts",
                D: "To accept language translation offers"
            },
            correct: "B",
...

        {
            ...
            options: {
                ...
                B: "Flip label positioning to the right, align text to the right, and ensure placeholder text follows RTL direction",
                C: "Only translate the text without changing layout",
            ...
            topics: ["Cultural Considerations", "Locale-Specific Formatting", "Multi-Language Navigation"]
        },

        {
            ...
            options: {
                A: "They're the same thing with different acronyms",
                B: "Internationalization is designing/building software to support multiple locales; localization is adapting that software for a specific locale with translations and cultural adaptations",
            ...
            topics: ["Cultural Considerations", "Multi-Language Navigation", "Internationalization Testing"]
        },
