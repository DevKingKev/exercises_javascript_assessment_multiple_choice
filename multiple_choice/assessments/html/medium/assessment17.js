module.exports = {
    metadata: {
        ...
        topicLinks: [
            { topicName: "Media Fragments", refLink: "https://developer.mozilla.org/en-US/docs/Web/Media/Formats/Video_concepts#media_fragments" },
            { topicName: "Multiple Track Elements", refLink: "https://developer.mozilla.org/en-US/docs/Web/HTML/Element/track" },
            { topicName: "Poster Image Optimization", refLink: "https://developer.mozilla.org/en-US/docs/Web/HTML/Element/video#poster" },
            { topicName: "Media Source Extensions (MSE)", refLink: "https://developer.mozilla.org/en-US/docs/Web/API/Media_Source_Extensions_API" },
            { topicName: "Picture-in-Picture API", refLink: "https://developer.mozilla.org/en-US/docs/Web/API/Picture-in-Picture_API" },
            { topicName: "Autoplay Policies", refLink: "https://developer.mozilla.org/en-US/docs/Web/Media/Autoplay_guide" },
            { topicName: "Advanced Video Attributes", refLink: "https://developer.mozilla.org/en-US/docs/Web/HTML/Element/video#attributes" },
            { topicName: "Cross-Origin Media", refLink: "https://developer.mozilla.org/en-US/docs/Web/HTML/CORS_enabled_image" },
            { topicName: "Media Performance Optimization", refLink: "https://developer.mozilla.org/en-US/docs/Web/Performance/Multimedia" },
            { topicName: "Adaptive Streaming Hints", refLink: "https://developer.mozilla.org/en-US/docs/Web/HTML/Element/source#type" }
        ],
        assessmentId: 17,
    ...
    questions: [
        {
            ...
            options: {
                A: "Loads 10-20 seconds of video data",
                B: "Specifies that the video should play from 10 seconds to 20 seconds",
            ...
            topics: ["Media Fragments", "Advanced Video Attributes"]
        },

        {
            ...
            options: {
                ...
                B: "Include multiple <pre><track></pre> elements, each with different <pre>srclang</pre> and <pre>src</pre> attributes",
                C: "Use the <pre>multilang</pre> attribute",
                D: "Combine all languages in one VTT file"
            },
            correct: "B",
            ...
            topics: ["Multiple Track Elements", "Media Performance Optimization"]
        },

        {
            ...
            topics: ["Poster Image Optimization", "Media Performance Optimization"]
        },

        {
            ...
            options: {
                ...
                B: "Enabling JavaScript to generate and feed media streams to video elements, supporting adaptive streaming and live content",
                C: "Extending media file formats",
                D: "Creating media source code"
            },
            correct: "B",
            ...
            topics: ["Media Source Extensions (MSE)", "Adaptive Streaming Hints"]
        },

        {
            ...
            options: {
                A: "Add the <pre>pictureinpicture</pre> attribute to the video element",
                B: "Use JavaScript: <pre>video.requestPictureInPicture()</pre> (HTML allows it by default unless disabled)",
            ...
            topics: ["Picture-in-Picture API", "Advanced Video Attributes"]
        },

        {
            ...
            options: {
                A: "All browsers allow unrestricted autoplay",
                B: "Most browsers allow autoplay for muted videos or when the user has interacted with the site; use <pre>muted</pre> and handle autoplay promises to detect failures",
            ...
            topics: ["Autoplay Policies", "Advanced Video Attributes"]
        },

        {
            ...
            options: {
                ...
                B: "To define a rectangular region of the video to display, cropping the frame",
                C: "To set the video player dimensions",
                D: "To define video margins"
            },
            correct: "B",
...

        {
            ...
            options: {
                ...
                B: "Use <pre>kind=\"subtitles\"</pre> for translations, <pre>kind=\"captions\"</pre> for transcriptions that include sound effects and speaker identification",
                C: "Subtitles are for movies; captions are for TV shows",
            ...
            topics: ["Multiple Track Elements", "Advanced Video Attributes"]
        },

        {
            ...
            topics: ["Cross-Origin Media", "Advanced Video Attributes"]
        },

        {
            ...
            options: {
                A: "To select specific tracks from a multi-track video file",
                B: "To name video tracks for analytics",
            ...
            topics: ["Media Fragments", "Multiple Track Elements"]
        },
...

        {
            ...
            options: {
                ...
                B: "<pre>none</pre> loads nothing until play; <pre>metadata</pre> loads duration/dimensions/tracks; <pre>auto</pre> loads as much as the browser decides, potentially the entire video",
                C: "<pre>metadata</pre> only loads thumbnail images",
            ...
            topics: ["Media Performance Optimization", "Advanced Video Attributes"]
        },

        {
            ...
            options: {
                ...
                B: "By allowing JavaScript to monitor bandwidth and switch between different quality segments dynamically during playback",
                C: "By compressing video on the fly",
...

        {
            ...
            options: {
                ...
                B: "Handle <pre>enterpictureinpicture</pre>, <pre>leavepictureinpicture</pre>, and <pre>resize</pre> events to track state and adapt UI",
                C: "Only the <pre>click</pre> event",
                D: "Only the <pre>pip</pre> event"
            },
            correct: "B",
...

        {
            ...
            options: {
                A: "To specify the file type only",
                B: "To provide detailed MIME type and codec information, helping browsers skip unsupported formats without downloading: <pre>type='video/mp4; codecs=\"avc1.42E01E, mp4a.40.2\"'</pre>",
            ...
            topics: ["Adaptive Streaming Hints", "Media Performance Optimization"]
        },

        {
            ...
            options: {
                ...
                B: "Check if <pre>document.pictureInPictureElement === video</pre>",
                C: "Use <pre>video.isPiP()</pre>",
                D: "Check <pre>video.mode === 'pip'</pre>"
            },
            correct: "B",
...

        {
            ...
            options: {
                ...
                B: "Direct linking to specific time ranges without requiring server-side support or video editing, enabling precise sharing and citations",
...

        {
            ...
            options: {
                ...
                B: "Marks which text track should be enabled by default when the page loads",
                C: "Provides default captions when others fail",
...

        {
            ...
            options: {
                ...
                B: "Place fallback content between <pre><video></pre> tags, use multiple <pre><source></pre> elements for format fallback, and handle <pre>error</pre> events in JavaScript",
                C: "Use the <pre>fallback</pre> attribute",
                D: "Fallback isn't possible for video"
            },
            correct: "B",
            ...
            topics: ["Advanced Video Attributes", "Media Performance Optimization"]
        },
...

        {
            ...
            options: {
                ...
                B: "Optimize file size (target <100KB), use modern formats (WebP), match video dimensions, consider lazy loading for below-fold videos, and use appropriate compression quality",
                C: "Always use maximum quality",
