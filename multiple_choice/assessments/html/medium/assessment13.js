module.exports = {
  "metadata": {
    ...
    "topicLinks": [
      ...
      {
        "topicName": "ARIA States and Properties",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Attributes"
      },
      {
        "topicName": "ARIA Live Regions",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/ARIA_Live_Regions"
      },
      {
        "topicName": "aria-expanded and aria-selected",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Attributes/aria-expanded"
      },
      {
        "topicName": "aria-checked and Form States",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Attributes/aria-checked"
      },
      {
        "topicName": "aria-controls and aria-owns",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Attributes/aria-controls"
      },
      {
        "topicName": "Focus Management with tabindex",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/tabindex"
      },
      {
        "topicName": "Skip Navigation Links",
        "refLink": "https://webaim.org/techniques/skipnav/"
      }
    ],
    "assessmentId": 13,
  ...
  "questions": [
    ...
    },
    {
      ...
      "options": {
        "A": "On elements that control expandable regions; valid values are \"true\", \"false\", and optionally \"undefined\"",
        "B": "On any collapsible element; valid values are \"yes\" and \"no\"",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "To specify which elements have permission to modify the current element",
        "C": "To define parent-child relationships between elements that aren't parent-child in the DOM",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Positive values make elements non-focusable",
        "C": "They only work in older browsers and break modern accessibility features",
        "D": "They override the natural DOM order and create maintenance difficulties and unexpected tab behavior"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Use <pre>aria-focus=\"dialog\"</pre> to automatically manage focus",
        "C": "Move focus into the dialog (typically to the first focusable element or the dialog itself), trap focus within the dialog, and restore focus to the trigger when closed",
    ...
    },
    {
      ...
      "options": {
        "A": "Add <pre>role=\"dropdown\"</pre> to a <pre><div></pre> and style it",
        "B": "Use native <pre><select></pre> whenever possible; if custom UI is required, implement button with aria-expanded, aria-haspopup, listbox/option roles, and keyboard navigation",
