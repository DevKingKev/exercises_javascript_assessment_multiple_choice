module.exports = {
    "metadata": {
        ...
        "topicLinks": [
            { "topicName": "data-* attributes", "refLink": "https://developer.mozilla.org/en-US/docs/Learn/HTML/Howto/Use_data_attributes" },
            { "topicName": "DOM dataset API", "refLink": "https://developer.mozilla.org/en-US/docs/Web/API/HTMLElement/dataset" },
            { "topicName": "CSS attribute selectors", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/Attribute_selectors" },
            { "topicName": "Progressive enhancement", "refLink": "https://developer.mozilla.org/en-US/docs/Glossary/Progressive_enhancement" },
            { "topicName": "Best practices", "refLink": "https://developer.mozilla.org/" }
        ],
        "assessmentId": 7,
    ...
    "questions": [
        {
            ...
            "options": {
                ...
                "B": "<pre>data-user-id=\"123\"</pre>",
                "C": "<pre>data:user-id=\"123\"</pre>",
                "D": "<pre>user-data-id=\"123\"</pre>"
            },
            "correct": "B",
        ...
        },
        {
            ...
            "options": {
                "A": "<pre>document.getElementById('item').dataset.userId</pre>",
                "B": "<pre>document.getElementById('item').getAttribute('user-id')</pre>",
        ...
        },
        {
            ...
            "topic": { "topics": ["CSS attribute selectors"] }
        },
        {
            "id": 4,
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "<pre><div data-info=\"{\\\"a\\\":1}\"></div></pre>",
                "C": "<pre>URL-encode or HTML-escape the JSON string before placing it into the attribute</pre>",
            ...
            "topic": { "topics": ["JSON in data attributes", "Best practices"] }
        },
        {
            "id": 7,
            ...
            "options": {
                "A": "<pre>const cfg = JSON.parse(elem.dataset.config);</pre>",
                "B": "<pre>const cfg = JSON.parse(decodeURIComponent(elem.getAttribute('data-config')));</pre>",
            ...
            "topic": { "topics": ["JSON in data attributes", "Security"] }
        },
        {
            "id": 8,
            ...
            "options": {
                ...
                "C": "<pre>Storing large sensitive secrets like API keys</pre>",
                "D": "<pre>Using attributes as test hooks for automated UI tests</pre>"
            },
            "correct": "C",
            ...
            "topic": { "topics": ["Use cases for custom data attributes"] }
        },
        {
            "id": 9,
            ...
            "options": {
                ...
                "B": "<pre>data-id</pre>",
                "C": "<pre>data-analytics-user-id</pre>",
            ...
            "topic": { "topics": ["Best practices", "Naming conventions"] }
        },
        {
            "id": 10,
            ...
            "topic": { "topics": ["Best practices", "Performance"] }
        },
        {
            "id": 11,
            ...
            "options": {
                "A": "<pre>document.querySelectorAll('button').forEach(b => b.addEventListener('click', onClick))</pre>",
                "B": "<pre>document.body.addEventListener('click', (e) =&gt; { const btn = e.target.closest('[data-action]'); if (btn) handle(btn.dataset.action); });</pre>",
            ...
            "topic": { "topics": ["Use cases for custom data attributes", "DOM dataset API"] }
        },
        {
            "id": 12,
            ...
            "options": {
                ...
                "B": "<pre>getAttribute returns values as strings; dataset provides camelCase properties</pre>",
                "C": "<pre>dataset automatically parses JSON into objects</pre>",
        ...
        },
        {
            ...
            "topic": { "topics": ["JSON in data attributes", "Performance"] }
        },
        {
            "id": 15,
            "question": "Which pattern helps avoid accidental collisions when multiple libraries use data attributes on the same page?",
            "options": {
                "A": "<pre>Use very short names like data-x</pre>",
                "B": "<pre>Use a vendor or feature prefix, e.g., data-app-slider-index</pre>",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "<pre>dataset.user === 'Alice'</pre>",
                "C": "<pre>dataset.user === \"Alice\" (with escaped quotes)</pre>",
                "D": "<pre>dataset.user === undefined</pre>"
            },
            "correct": "B",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "<pre>Use ARIA attributes for accessibility rather than relying on data-* for conveying important info</pre>",
                "C": "<pre>data-* attributes are required for semantic HTML</pre>",
            ...
            "topic": { "topics": ["Best practices", "Accessibility"] }
        },
        {
            "id": 18,
            ...
            "options": {
                ...
                "B": "<pre>It separates test selectors from CSS classes, making styling refactors safer</pre>",
                "C": "<pre>It improves production performance</pre>",
            ...
            "topic": { "topics": ["Use cases for custom data attributes", "Testing"] }
        },
        {
            "id": 19,
            ...
            "options": {
                ...
                "B": "<pre>Emit identical data-* attribute values from the server and avoid DOM-only mutations before hydration</pre>",
                "C": "<pre>Remove all data attributes during server rendering</pre>",
                "D": "<pre>Use dataset to generate attribute names at runtime</pre>"
            },
            "correct": "B",
            ...
            "topic": { "topics": ["Best practices", "SSR"] }
        },
        {
            "id": 20,
            ...
            "options": {
                ...
                "B": "<pre>Always HTML-escape or encode values written into attributes</pre>",
                "C": "<pre>Use innerHTML to populate attributes</pre>",
                "D": "<pre>Serialize functions into attributes</pre>"
            },
            "correct": "B",
            ...
            "topic": { "topics": ["Security", "Best practices"] }
        },
        {
            "id": 21,
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "<pre>Prefer attributes for small, descriptive metadata and use in-memory state for large mutable data</pre>",
                "C": "<pre>Always use attributes because they persist across reloads</pre>",
                "D": "<pre>Never use attributes; they are deprecated</pre>"
            },
            "correct": "B",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "<pre>Buffer updates and apply them in a single requestAnimationFrame callback</pre>",
                "C": "<pre>Use innerHTML to rewrite the whole element</pre>",
                "D": "<pre>Use synchronous XHR before setting attribute</pre>"
            },
            "correct": "B",
            ...
            "topic": { "topics": ["Performance", "Best practices"] }
        },
        {
            "id": 25,
            ...
            "options": {
                ...
                "B": "<pre>URL-encode or HTML-escape JSON string server-side, write into data- attribute, then decode and JSON.parse on client with try/catch</pre>",
                "C": "<pre>Store functions inside data attributes to reduce client requests</pre>",
