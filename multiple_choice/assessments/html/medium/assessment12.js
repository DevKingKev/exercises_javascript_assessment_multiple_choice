module.exports = {
  "metadata": {
    ...
    "topicLinks": [
      {
        "topicName": "Microdata Attributes (itemscope, itemtype, itemprop)",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/HTML/Microdata"
      },
      {
        "topicName": "Schema.org Vocabulary",
        "refLink": "https://schema.org/"
      },
      {
        "topicName": "Product Schema",
        "refLink": "https://schema.org/Product"
      },
      {
        "topicName": "Person and Organization Schemas",
        "refLink": "https://schema.org/Person"
      },
      {
        "topicName": "Structured Data SEO Benefits",
        "refLink": "https://developers.google.com/search/docs/appearance/structured-data/intro-structured-data"
      },
      {
        "topicName": "JSON-LD Alternative",
        "refLink": "https://json-ld.org/"
      },
      {
        "topicName": "Testing Structured Data",
        "refLink": "https://developers.google.com/search/docs/appearance/structured-data"
      },
      {
        "topicName": "Nested Microdata Items",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/HTML/Microdata"
      }
    ],
    "assessmentId": 12,
  ...
  "questions": [
    {
      ...
      "options": {
        "A": "To create a new item and establish that the element and its descendants contain information about a particular thing",
        "B": "To define the CSS scope for styling microdata elements",
    ...
    },
    {
      ...
      "options": {
        "A": "A collaborative vocabulary maintained by major search engines for marking up structured data",
        "B": "A proprietary Google format for search engine optimization",
    ...
    },
    {
      ...
      "options": {
        "A": "Use <pre>itemprop=\"brand.name\"</pre> with dot notation",
        "B": "Add another <pre>itemscope</pre> and <pre>itemtype</pre> within the parent item's scope",
    ...
    },
    {
      ...
      "options": {
        "A": "Add <pre>itemprop=\"email\"</pre> and <pre>itemprop=\"telephone\"</pre> directly on the Organization",
        "B": "Use nested <pre>itemprop=\"contactPoint\"</pre> with an itemscope for ContactPoint type",
    ...
    },
    {
      ...
      "options": {
        "A": "Use <pre><!-- itemprop=\"propertyName\" value=\"value\" --></pre> in comments",
        "B": "Add <pre>style=\"display:none\"</pre> to regular elements with itemprop",
        "C": "Use <pre><meta itemprop=\"propertyName\" content=\"value\"></pre>",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "reviewRating, reviewBody, datePublished",
        "C": "name, url, jobTitle, sameAs (for social profiles)",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "To create bidirectional references between two items",
        "C": "To include properties from other elements on the page that are outside the itemscope tree",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Microdata is for HTML, RDFa is for XML, and JSON-LD is for JavaScript applications",
        "C": "RDFa is the only valid format; microdata and JSON-LD are deprecated",
        "D": "They are three different syntaxes for embedding structured data in web pages, all supported by search engines"
      },
      "correct": "D",
