  ...
  "questions": [
    {
      ...
      "options": {
        "A": "It creates a dropdown menu for form selection",
        "B": "It validates user input against a predefined list",
        "C": "It provides suggested autocomplete options for an input field",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "They prevent form submission until all fields are filled",
        "C": "They automatically focus on the first field in the group",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "It validates mathematical input formats",
        "C": "It stores calculated values for form submission",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "The input's values are copied to the target form",
        "C": "The input inherits the form's validation rules",
    ...
    },
    {
      ...
      "options": {
        "A": "It defines the form's method as an action",
        "B": "It specifies the form validation action",
        "C": "It overrides the form's action URL for that specific submission",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "It defines how form data is encoded",
        "C": "It specifies the validation method for form fields",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Datalist without accessible name",
        "C": "Progress element without current value",
        "D": "Incorrect use of fieldset for single controls"
      },
      "correct": "B",
    ...
    },
    {
      ...
      "options": {
        "A": "Automatic animation and transitions",
        "B": "Built-in semantics and accessibility support",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "They control animation speed thresholds",
        "C": "They set minimum and maximum display values",
    ...
    },
    {
      ...
      "options": {
        "A": "formnovalidate is for client-side, novalidate for server-side",
        "B": "formnovalidate works on all buttons, novalidate on specific ones",
        "C": "formnovalidate applies to a specific button, novalidate to entire form",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "They should be hidden from screen readers",
        "C": "They require JavaScript for accessibility",
        "D": "They automatically announce updates to screen readers"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "Add role=\"presentation\"",
        "D": "Remove the legend element"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "It automatically validates external inputs",
        "B": "It improves form submission performance",
        "C": "It enables cross-origin form submissions",
        "D": "It allows flexible form layout in HTML structure"
      },
      "correct": "A",
    ...
    },
    {
      ...
      "options": {
        "A": "It sets the maximum possible value",
        "B": "It indicates the ideal value within the range",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "They cannot be styled consistently",
        "D": "Use appearance: none and custom styles"
      },
      "correct": "D",
