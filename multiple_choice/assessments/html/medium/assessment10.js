  ...
  "questions": [
    {
      ...
      "options": {
        "A": "It will be called only on HTTPS pages; on HTTP pages the success callback is called with null.",
        "B": "It is only called when the device cannot acquire a fix; permission denial does not trigger it.",
        "C": "It is always called if the user denies permission; the PositionError code will indicate PERMISSION_DENIED.",
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>contenteditable=\"false\"</pre> disables spellcheck",
        "B": "<pre>spellcheck=\"false\"</pre> (attribute) or element.spellcheck = false",
    ...
    },
    {
      ...
      "options": {
        "A": "That the content must be translated",
        "B": "That the content should not be machine-translated",
    ...
    },
    {
      ...
      "options": {
        "A": "It is a wrapper for navigator.clipboard during drag-and-drop",
        ...
        "D": "It contains a set of key/value pairs representing data being transferred and is used on dragstart/drop handlers"
      },
      "correctAnswer": "D",
    ...
    {
      "question": "Which Geolocation option improves the chance of a faster callback but may return a cached position?",
      "options": {
        "A": "enableHighAccuracy: true",
        "B": "maximumAge: 0",
        "C": "timeout: 0",
        "D": "maximumAge: Infinity (allow cached)"
      },
      "correctAnswer": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Clear all storage for the origin",
        "C": "Do nothing (no error)",
    ...
    },
    {
      ...
      "options": {
        "A": "Use localStorage to store the File objects directly",
    ...
    },
    {
      ...
      "options": {
        "A": "dragstart → drag → drop → dragend → dragover",
        "B": "dragstart → drop → dragenter → dragover → dragend",
        "C": "dragstart → dragenter → dragover → drop → dragend",
    ...
    },
    {
      ...
      "options": {
        "A": "Rely on navigator.geolocation.getCurrentPosition even when offline",
        "B": "Store the position object (latitude/longitude/timestamp) in localStorage or IndexedDB and use it when offline",
    ...
    },
    {
      ...
      "options": {
        "A": "role=\"option\"",
        "B": "translate=\"no\"",
        "C": "aria-grabbed (or set aria-dropeffect when appropriate) alongside draggable",
    ...
    },
    {
      ...
      "options": {
        "A": "No permission is ever required for clipboard writes",
        "B": "User gesture and secure context (HTTPS); some clipboard writes require explicit permission",
    ...
    {
      "question": "Which of the following best describes using translate attribute for machine translation fallbacks?",
      "options": {
        "A": "translate=\"yes\" will automatically translate the content without user choice",
        "B": "translate=\"no\" prevents automatic machine translation of that element’s content",
