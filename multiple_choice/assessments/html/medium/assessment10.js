module.exports = {
    metadata: {
        ...
        assessmentId: 10,
        // assessmentUniqueId must be the millisecond timestamp taken at file creation
    ...
    questions: [
        {
            ...
            options: {
                A:
                    'It is always called if the user denies permission; the PositionError code will indicate PERMISSION_DENIED.',
                B:
                    'It is only called when the device cannot acquire a fix; permission denial does not trigger it.',
                C:
                    'It will be called only on HTTPS pages; on HTTP pages the success callback is called with null.',
                D:
                    'It is deprecated in modern browsers and replaced by Promise-based geolocation.'
            },
            correctAnswer: 'A',
        ...
        {
            question:
                'Which storage facility persists across browser sessions until explicitly cleared by script or user?',
            options: {
                A: 'sessionStorage',
                B: 'localStorage',
        ...
        {
            question:
                'Which attribute or property tells the browser not to spellcheck a particular editable region?',
            options: {
...

        {
            ...
            options: {
                ...
                B: 'maximumAge: 0',
                C: 'maximumAge: Infinity (allow cached)',
                D: 'timeout: 0'
            },
            correctAnswer: 'C',
        ...
        {
            question:
                'What will <pre>localStorage.removeItem(key)</pre> do if the key does not exist?',
            options: {
        ...
        {
            question:
                'During dragover on a potential drop target, what must you do to allow dropping?',
            options: {
        ...
        {
            question:
                'Which of these is a valid reason that localStorage.setItem may throw a QuotaExceededError?',
            options: {
