module.exports = {
  ...
  "questions": [
    ...
    },
    {
      ...
      "options": {
        "A": "User edits may insert, remove, or restructure DOM nodes (e.g., <pre><br></pre>, <pre><div></pre>), so scripts should handle DOM normalization",
        ...
        "D": "The browser always preserves the original element structure and only replaces text nodes"
      },
      "correct": "A",
    ...
    },
    {
      ...
      "options": {
        "A": "It is only present on the drop target and not accessible from the drag source",
        "B": "It contains a set of key/value pairs representing data being transferred and is used on dragstart/drop handlers",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "event.clipboardData.getData(\"text/html\") inside paste handler",
        "C": "document.execCommand(\"getHTML\")",
        "D": "navigator.clipboard.readText() only provides text, not HTML"
      },
      "correct": "B",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Call event.preventDefault() in the dragover handler",
        "C": "Set the target element to contenteditable",
    ...
    },
    {
      ...
      "options": {
        ...
        "D": "IndexedDB (only for persistent settings)"
      },
      "correct": "B",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "document.activeElement === theElement (and check selection.rangeCount)",
        "D": "theElement.contentEditable === \"true\" only"
      },
      "correct": "C",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Call stop() on the returned Watcher object",
        "C": "Call navigator.geolocation.clearWatch(id) when updates are no longer needed",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Replace all tags with their entity-escaped equivalents and show as text",
        "C": "Store raw HTML and sanitize on output with a robust sanitizer",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Because localStorage is read-only and never allows writes",
        "C": "Storage quota exceeded for the origin (too much data stored)",
    ...
    },
    {
      ...
      "options": {
        "A": "Wrap draggable elements in <pre>button</pre> elements",
        "B": "Only support mouse users; ARIA is unnecessary",
        "C": "Also provide keyboard alternatives and ARIA attributes to indicate draggable and droppable roles",
    ...
    },
    {
      ...
      "options": {
        "A": "<pre><span contenteditable=\"false\">ID: 42</span></pre>",
        "B": "<pre><span spellcheck=\"false\">ID: 42</span></pre>",
        "C": "<pre><span translate=\"no\">ID: 42</span></pre>",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "Use localStorage to store the File objects directly",
        "D": "Call event.preventDefault() in dragover and drop handlers, then use event.dataTransfer.files in drop"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "localStorage preserves type information (no conversion needed)",
        "B": "Numbers are stored with higher precision in localStorage",
        "C": "A numeric key will be auto-converted to a number when read",
        "D": "localStorage stores values as strings, so you must parseInt/parseFloat when reading numbers back"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "dragstart → dragend → drop",
        "C": "dragstart → drag → drop → dragend → dragover",
        "D": "dragstart → dragenter → dragover → drop → dragend"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "Write the position into a cookie with large expiry",
        "D": "Store the position object (latitude/longitude/timestamp) in localStorage or IndexedDB and use it when offline"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "translate=\"no\"",
        "D": "aria-grabbed (or set aria-dropeffect when appropriate) alongside draggable"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "Clipboard API is available only in service workers",
        "B": "No permission is ever required for clipboard writes",
        "C": "Clipboard writes only work in contenteditable elements",
        "D": "User gesture and secure context (HTTPS); some clipboard writes require explicit permission"
      },
      "correct": "D",
