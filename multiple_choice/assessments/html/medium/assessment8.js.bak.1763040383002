module.exports = {
    metadata: {
        ...
        topicLinks: [
            ...
            { topicName: "JSON", refLink: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/JSON" },
            { topicName: "Security (XSS)", refLink: "https://developer.mozilla.org/en-US/docs/Glossary/Cross-site_scripting" },
            { topicName: "Performance", refLink: "https://developer.mozilla.org/en-US/docs/Web/Performance" },
            { topicName: "Accessibility (ARIA)", refLink: "https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA" },
            { topicName: "Server-side rendering (SSR)", refLink: "https://developer.mozilla.org/en-US/docs/Glossary/Server-side_rendering" }
        ],
        assessmentId: 8,
    ...
    questions: [
        ...
        },
        {
            ...
            options: {
                A: "<pre>document.getElementById(\"item\").dataset.count</pre>",
                B: "<pre>document.getElementById(\"item\").getAttribute(\"data-count\")</pre>",
        ...
        },
        {
            ...
            options: {
                ...
                D: "<pre>dataset.dataUserRole</pre>"
            },
            correct: "D",
        ...
        },
        {
            ...
            topic: { topics: ["JSON", "Security (XSS)"] }
        },
        {
            id: 6,
            question: "Which of these should NEVER be stored in a data-* attribute?",
            options: {
                A: "<pre>Short UI flags for progressive enhancement</pre>",
                B: "<pre>Test hooks like data-test-id</pre>",
            ...
            topic: { topics: ["Security (XSS)", "Performance"] }
        },
        {
            id: 7,
            ...
            options: {
                ...
                B: "<pre>Use inline onclick attributes for each button</pre>",
                C: "<pre>Bind separate listeners to each button at load time</pre>",
            ...
            topic: { topics: ["DOM dataset API", "Performance"] }
        },
        {
            id: 8,
            ...
            options: {
                ...
                B: "<pre>data-fooBar=\"5\"</pre>",
                C: "<pre>data_foo_bar=\"5\"</pre>",
                D: "<pre>no attribute</pre>"
            },
            correct: "D",
        ...
        },
        {
            ...
            options: {
                A: "<pre>data-id</pre>",
                B: "<pre>data-app-widget-index</pre>",
                C: "<pre>dataUserIndex</pre>",
        ...
        },
        {
            ...
            options: {
                ...
                B: "<pre>element.getAttribute(\"data-value\")</pre>",
                C: "<pre>element.value</pre>",
                D: "<pre>element.attributes[\"data-value\"].nodeValue</pre>"
            },
            correct: "D",
        ...
        },
        {
            ...
            options: {
                A: "<pre>Insert raw text and rely on the browser</pre>",
                B: "<pre>HTML-escape or encode the value before writing it into the attribute</pre>",
                C: "<pre>Wrap the text in a <pre> element inside the attribute</pre>",
        ...
        },
        {
            ...
            options: {
                ...
                B: "<pre>Ensure server-rendered attributes match what the client expects and avoid pre-hydration mutations</pre>",
                C: "<pre>Remove all data attributes in server HTML</pre>",
            ...
            topic: { topics: ["Server-side rendering (SSR)", "Performance"] }
        },
        {
            id: 15,
        ...
        },
        {
            ...
            options: {
                ...
                C: "<pre>data-* attributes are required for accessible widgets</pre>",
                D: "<pre>data-* can replace labels to reduce DOM size</pre>"
            },
            correct: "D",
        ...
        },
        {
            ...
            options: {
                ...
                B: "<pre>const cfg = JSON.parse(decodeURIComponent(element.getAttribute(\"data-config\")));</pre>",
                C: "<pre>const cfg = eval(element.getAttribute(\"data-config\"));</pre>",
        ...
        },
        {
            ...
            options: {
                ...
                C: "<pre>Attributes persist across page loads by default</pre>",
                D: "<pre>Attributes automatically serialize complex objects</pre>"
            },
            correct: "C",
        ...
        },
        {
            ...
            options: {
                ...
                B: "<pre>When you want the camelCase mapping</pre>",
                C: "<pre>When you want automatic JSON parsing</pre>",
                D: "<pre>When you want numeric typing</pre>"
            },
            correct: "B",
        ...
        },
        {
            ...
            options: {
                ...
                C: "<pre>Use innerHTML to insert values into attributes</pre>",
                D: "<pre>Serialize functions and eval on the client</pre>"
            },
            correct: "C",
