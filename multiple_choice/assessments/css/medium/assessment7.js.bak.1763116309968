module.exports = {
    metadata: {
        ...
        topicLinks: [
            { "topicName": "Advanced Flexbox", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_flexible_box_layout" },
            { "topicName": "flex-grow", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/flex-grow" },
            { "topicName": "flex-shrink", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/flex-shrink" },
            { "topicName": "flex-basis", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/flex-basis" },
            { "topicName": "flex shorthand", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/flex" },
            { "topicName": "order property", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/order" },
            { "topicName": "align-self", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/align-self" },
            { "topicName": "flex-wrap", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/flex-wrap" },
            { "topicName": "align-content", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/align-content" },
            { "topicName": "Nested Flex Containers", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_flexible_box_layout/Basic_concepts_of_flexbox#nested_flex_containers" },
            { "topicName": "Flexbox Spacing", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_flexible_box_layout/Aligning_items_in_a_flex_container" },
            { "topicName": "Flexbox Patterns", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_flexible_box_layout/Typical_use_cases_of_flexbox" }
        ],
        keywords: [
            "flexbox",
            "flex-grow",
    ...
    questions: [
        ...
        },
        {
            ...
            options: {
                ...
                B: "1:2:1 ratio (second item gets twice as much)",
        ...
        },
        {
            ...
            options: {
                ...
                B: "The item from shrinking below its base size",
                C: "The item from displaying",
        ...
        },
        {
            ...
            options: {
                A: "The final size of the item",
                B: "The initial main size of the item before growing or shrinking",
                C: "The minimum size",
                D: "The maximum size"
            },
            correct: "B",
        ...
        },
        {
            ...
            options: {
                A: "<pre>flex-grow: 1; flex-shrink: 1; flex-basis: 0%;</pre>",
                B: "<pre>flex-grow: 1;</pre> only",
        ...
        },
        {
            ...
            options: {
                A: "Removes the item from the flex container",
                B: "Makes the item inflexible (cannot grow or shrink)",
        ...
        },
        {
            ...
            options: {
                A: "Sorts items alphabetically",
                B: "Controls the visual order of flex items without changing the DOM",
        ...
        },
        {
            ...
            options: {
                ...
                B: "Aligns the item to the end of the cross axis",
                C: "Moves the item to the end position",
                D: "Aligns text to the end"
            },
            correct: "B",
        ...
        },
        {
            ...
            options: {
                ...
                B: "Yes, align-self applies to individual items",
                C: "Only if align-items is not set",
                D: "Only in nested flex containers"
            },
            correct: "B",
        ...
        },
        {
            ...
            options: {
                ...
                B: "Flex items to wrap onto multiple lines when they don't fit",
                C: "Wrapping the container",
                D: "Word wrapping"
            },
            correct: "B",
        ...
        },
        {
            ...
            options: {
                A: "They are the same",
                B: "<pre>align-items</pre> aligns items within each line; <pre>align-content</pre> aligns the lines themselves",
                C: "<pre>align-content</pre> doesn't work",
                D: "<pre>align-items</pre> only works with grid"
            },
            correct: "B",
        ...
        },
        {
            ...
            options: {
                ...
                B: "Yes, by setting display: flex on the flex item",
                C: "Only with a special property",
                D: "Only in CSS Grid"
            },
            correct: "B",
        ...
        },
        {
            ...
            options: {
                ...
                B: "No, each flex context is independent",
                C: "Only if explicitly set",
        ...
        },
        {
            ...
            options: {
                A: "No advantage",
                B: "Gap only adds space between items, not at the edges, and requires less code",
                C: "Gap is faster",
                D: "Gap works in all browsers"
            },
            correct: "B",
        ...
        },
        {
            ...
            options: {
                ...
                B: "Using a flex container with <pre>min-height: 100vh</pre> and pushing footer to the bottom with <pre>margin-top: auto</pre>",
                C: "Sticky footers require JavaScript",
                D: "Using <pre>position: fixed</pre>"
            },
            correct: "B",
        ...
        },
        {
            ...
            options: {
                A: "Items disappear",
                B: "Items become equal width regardless of content",
