module.exports = {
    metadata: {
        ...
        topicLinks: [
            { "topicName": "CSS Animations", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_animations/Using_CSS_animations" },
            { "topicName": "@keyframes", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/@keyframes" },
            { "topicName": "animation-name", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/animation-name" },
            { "topicName": "animation-duration", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/animation-duration" },
            { "topicName": "animation-timing-function", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/animation-timing-function" },
            { "topicName": "animation-delay", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/animation-delay" },
            { "topicName": "animation-iteration-count", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/animation-iteration-count" },
            { "topicName": "animation-direction", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/animation-direction" },
            { "topicName": "animation-fill-mode", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/animation-fill-mode" },
            { "topicName": "animation-play-state", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/animation-play-state" },
            { "topicName": "animation", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/animation" }
        ],
        keywords: [
            "animation",
            "@keyframes",
    ...
    questions: [
        {
            ...
            options: {
                A: "To define animation styles at various points in the animation sequence",
                B: "To set animation speed",
        ...
        },
        {
            ...
            options: {
                A: "<pre>animation: @slide;</pre>",
                B: "<pre>animation-name: slide;</pre>",
        ...
        },
        {
            ...
            options: {
                ...
                B: "Animation lasts 2 seconds from start to finish",
                C: "Animation repeats every 2 seconds",
                D: "Animation pauses for 2 seconds"
            },
            correct: "B",
        ...
        },
        {
            ...
            options: {
                ...
                B: "Animation proceeds at constant speed from start to finish",
                C: "Animation accelerates linearly",
                D: "Animation runs vertically"
            },
            correct: "B",
        ...
        },
        {
            ...
            options: {
                ...
                B: "Starts the animation immediately at a point partway through its cycle",
        ...
        },
        {
            ...
            options: {
                ...
                B: "Animation repeats forever until stopped",
                C: "Animation runs at infinite speed",
        ...
        },
        {
            ...
            options: {
                ...
                B: "Plays the animation 2.5 times (2 complete cycles plus half of a third)",
                C: "Rounds to 3 iterations",
        ...
        },
        {
            ...
            options: {
                A: "No difference",
                B: "<pre>alternate</pre> starts forward; <pre>alternate-reverse</pre> starts backward",
        ...
        },
        {
            ...
            options: {
                A: "Animation runs in reverse",
                B: "Element applies styles from the first keyframe (0%) during animation-delay period",
        ...
        },
        {
            ...
            options: {
                ...
                B: "<pre>animation-play-state: paused;</pre>",
                C: "<pre>animation: stop;</pre>",
        ...
        },
        {
            ...
            options: {
                ...
                B: "Yes, separate animations with commas",
                C: "Only with JavaScript",
                D: "Yes, but they override each other"
            },
            correct: "B",
        ...
        },
        {
            ...
            options: {
                A: "<pre>from</pre> is 0%, <pre>to</pre> is 100%",
        ...
        },
        {
            ...
            options: {
                ...
                B: "Yes, you can define any percentage keyframes like 25%, 50%, 75%",
                C: "Only 50% is allowed",
        ...
        },
        {
            ...
            options: {
                A: "<pre>ease-out</pre>",
                B: "Custom <pre>cubic-bezier()</pre> with values outside 0-1 range",
                C: "<pre>linear</pre>",
                D: "<pre>bounce</pre>"
            },
            correct: "B",
        ...
        },
        {
            ...
            options: {
                ...
                B: "Yes, you can specify <pre>animation-timing-function</pre> within individual keyframe blocks",
        ...
        },
        {
            ...
            options: {
                A: "No difference",
                B: "CSS is declarative, more performant, and doesn't require JavaScript execution",
                C: "JavaScript is always better",
                D: "fill-mode only works on hover"
            },
            correct: "B",
