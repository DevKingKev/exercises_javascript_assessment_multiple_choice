  ...
  "questions": [
    {
      ...
      "options": {
        "A": "Establishes a containment context for container queries based on inline dimension",
        "B": "Sets the container's inline size",
    ...
    },
    {
      ...
      "options": {
        "A": "The margin at the start of the inline direction (left in LTR, right in RTL)",
        "B": "Always left margin",
        "C": "Top margin",
        "D": "Inner margin"
      },
      "correct": "A",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Only works on screen",
        "C": "Creates page breaks",
        "D": "Prevents page breaks from occurring inside the element when printing"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Dark mode requires JavaScript",
        "C": "Using theme attribute",
        "D": "Using @media (prefers-color-scheme: dark)"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Creates gradients",
        "C": "Indicates which color schemes the element supports, affecting browser UI elements",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "Smooth scrolling animations when jumping to anchors or using scrollTo",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Font loading speed",
        "C": "Axes in variable fonts for fine-tuned control",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Reduces text quality",
        "C": "Enables kerning and ligatures for better typography at the cost of performance",
    ...
    },
    {
      ...
      "options": {
        "A": "Fills gaps in the grid by placing items in earlier empty spaces",
        "B": "Makes grid items denser",
    ...
    },
    {
      ...
      "options": {
        "A": "They are identical",
        "B": "auto-fill is faster",
        "C": "auto-fit collapses empty tracks, auto-fill creates empty tracks",
    ...
    },
    {
      ...
      "options": {
        "A": "Changes the visual order of items without changing HTML order",
        "B": "Orders items alphabetically",
        "C": "Orders by size",
    ...
    },
    {
      ...
      "options": {
        "A": "Aligns all items",
        "B": "Centers the container",
        "C": "Aligns text",
        "D": "Overrides align-items for a specific flex item"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "Justifies text",
        "B": "Creates justified layouts",
        "C": "Only works in Flexbox",
        "D": "Aligns an individual grid item along the inline axis within its cell"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "Page navigation",
        "B": "Web pages only",
        "C": "Page margins and size when printing",
        "D": "Page loading"
      },
      "correct": "C",
    ...
    },
    {
      ...
      "options": {
        "A": "Makes text bold",
        "B": "Only affects Asian languages",
        "C": "Rotates elements",
        "D": "Creates vertical text flow from right to left (top to bottom, columns right to left)"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "D": "Isolates layout calculations to improve rendering performance"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "Shorthand for top, right, bottom, left positioning offsets",
        "B": "Insert content",
        "C": "Inner padding",
        "D": "Inline styles"
      },
