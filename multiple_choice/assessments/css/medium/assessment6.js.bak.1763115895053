module.exports = {
    metadata: {
        ...
        topicLinks: [
            { "topicName": "CSS Grid Layout", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_grid_layout" },
            { "topicName": "display: grid", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/display" },
            { "topicName": "grid-template-columns", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/grid-template-columns" },
            { "topicName": "grid-template-rows", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/grid-template-rows" },
            { "topicName": "gap properties", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/gap" },
            { "topicName": "grid-template-areas", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/grid-template-areas" },
            { "topicName": "grid-column and grid-row", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/grid-column" },
            { "topicName": "fr unit", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_grid_layout/Basic_concepts_of_grid_layout#the_fr_unit" },
            { "topicName": "repeat() function", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/repeat" },
            { "topicName": "minmax()", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/minmax" },
            { "topicName": "Implicit vs Explicit Grid", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_grid_layout/Basic_concepts_of_grid_layout#the_implicit_and_explicit_grid" },
            { "topicName": "Auto-placement Algorithm", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_grid_layout/Auto-placement_in_grid_layout" }
        ],
        keywords: [
            "grid",
            "display: grid",
    ...
    questions: [
        {
            ...
            options: {
                ...
                B: "Makes it a grid container with its children as grid items",
                C: "Applies a background grid pattern",
        ...
        },
        {
            ...
            options: {
                ...
                B: "Three columns: 100px, 200px, and 100px wide",
                C: "Three rows",
                D: "A single column repeated three times"
            },
            correct: "B",
        ...
        },
        {
            ...
            options: {
                A: "All rows 50px",
                B: "First row 50px, second row fits content, third row 100px",
                C: "All rows automatic",
                D: "First and third 50px, middle 100px"
            },
            correct: "B",
        ...
        },
        {
            ...
            options: {
                A: "They are identical; <pre>gap</pre> is the modern standard property name",
                B: "<pre>grid-gap</pre> is faster",
                C: "<pre>gap</pre> doesn't work in grid",
                D: "<pre>grid-gap</pre> is required for grid layouts"
            },
            correct: "A",
        ...
        },
        {
            ...
            options: {
                A: "10px gap on all sides",
                B: "10px row gap, 20px column gap",
        ...
        },
        {
            ...
            options: {
                A: "A 2-column, 3-row layout with named areas",
        ...
        },
        {
            ...
            options: {
                A: "Fixed ratio",
                B: "A fraction of the available space in the grid container",
                C: "Frame rate",
        ...
        },
        {
            ...
            options: {
                ...
                B: "Three columns: first and third are equal, middle is twice as wide",
        ...
        },
        {
            ...
            options: {
                ...
                B: "The grid defined by grid-template-columns, grid-template-rows, and grid-template-areas",
                C: "The grid that auto-generates",
        ...
        },
        {
            ...
            options: {
                A: "Hidden grid lines",
                B: "Automatically generated rows or columns when items are placed outside the explicit grid",
                C: "The grid template",
                D: "Grid gaps"
            },
            correct: "B",
        ...
        },
        {
            ...
            options: {
                A: "Error - too many items",
                B: "Only 3 items are displayed",
                C: "The grid auto-generates additional rows (implicit grid)",
        ...
        },
        {
            ...
            options: {
                A: "Random placement",
                B: "Places items row by row, filling each row before moving to the next",
                C: "Column by column",
        ...
        },
        {
            ...
            options: {
                A: "Starts at column line 2 and spans 3 columns",
                B: "Starts at column 2 and ends at column 3",
                C: "Spans from column 2 to 3",
                D: "Invalid syntax"
            },
            correct: "A",
        ...
        },
        {
            ...
            options: {
                ...
                B: "Yes, fixed sizes are allocated first, then fr units share the remaining space",
                C: "Only with minmax()",
