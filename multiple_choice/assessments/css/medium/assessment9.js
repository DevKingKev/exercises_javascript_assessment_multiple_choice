module.exports = {
  "metadata": {
    ...
    "topicLinks": [
      {
        "topicName": "CSS Custom Properties",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/Using_CSS_custom_properties"
      },
      {
        "topicName": "CSS Variables",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/--*"
      },
      {
        "topicName": "var() Function",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/var"
      },
      {
        "topicName": ":root Selector",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/:root"
      },
      {
        "topicName": "Cascading Variables",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/Cascade"
      },
      {
        "topicName": "JavaScript Manipulation",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/API/CSSStyleDeclaration/setProperty"
      }
    ],
    "keywords": [
      "custom properties",
  ...
  "questions": [
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "In the <pre>html</pre> selector",
        "C": "In the <pre>:root</pre> pseudo-class",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "The browser assigns a default value",
        "C": "The property is treated as invalid and ignored (browser uses initial/inherited value)",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Only if you use <pre>inherit</pre> keyword",
        "C": "Yes, custom properties inherit by default like color and font-family",
    ...
    },
    {
      ...
      "options": {
        "A": "Local to that element and its descendants",
        "B": "Global to the entire document",
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>getComputedStyle(element).getPropertyValue('--variable-name')</pre>",
        "B": "<pre>element.style.--variableName</pre>",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "<pre>document.setVariable('--variable-name', 'value');</pre>",
        "C": "<pre>element.setCSSVariable('--variable-name', 'value');</pre>",
        "D": "<pre>element.style.setProperty('--variable-name', 'value');</pre>"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "D": "No, variables cannot be used in media query conditions"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "Yes, they can store any valid CSS value including lists and complex values",
        "D": "Only color values"
      },
      "correct": "C",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Browser automatically adds px",
        "C": "Invalid, you cannot concatenate units this way",
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>width: calc(var(--base-width) + 20px);</pre>",
        "B": "You cannot combine them",
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>:root</pre> has higher specificity than <pre>html</pre>",
        "B": "No difference",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Use media queries only",
        "C": "Use JavaScript to change all colors",
        "D": "Define color variables in <pre>:root</pre>, then override them in a <pre>.dark-mode</pre> class on the root element"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Only for numeric values",
        "C": "Only if they're in the same selector",
        "D": "Yes, you can use <pre>var()</pre> in variable definitions"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "Component-specific values that shouldn't affect other parts of the page",
    ...
    },
    {
      ...
      "options": {
        ...
        "D": "Yes, variables work in content property: <pre>content: var(--icon);</pre>"
      },
      "correct": "D",
