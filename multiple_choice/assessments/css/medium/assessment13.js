module.exports = {
  "metadata": {
    ...
    "questionCount": 25,
    "assessmentId": 13,
    "assessmentUniqueId": 1763119900119,
    ...
    "topicLinks": [
      {
        "topicName": "CSS Overflow",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/overflow"
      },
      {
        "topicName": "overflow-x",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/overflow-x"
      },
      {
        "topicName": "overflow-y",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/overflow-y"
      },
      {
        "topicName": "Scroll Snapping",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_scroll_snap"
      },
      {
        "topicName": "scroll-snap-type",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/scroll-snap-type"
      },
      {
        "topicName": "scroll-snap-align",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/scroll-snap-align"
      },
      {
        "topicName": "overscroll-behavior",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/overscroll-behavior"
      },
      {
      ...
      {
        "topicName": "::-webkit-scrollbar",
        "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/::-webkit-scrollbar"
      }
    ],
    "keywords": [
      "overflow",
  ...
  "questions": [
    {
      ...
      "options": {
        "A": "No difference",
        "B": "<pre>clip</pre> only works on images",
        "C": "<pre>clip</pre> is deprecated",
        "D": "<pre>hidden</pre> allows programmatic scrolling; <pre>clip</pre> prevents all scrolling including programmatic"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Creates automatic scrolling",
        "C": "Makes scrolling mandatory",
        "D": "Forces scroll to snap to defined snap points on the x-axis after scrolling"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "Defines that this element should snap when its center aligns with the scroll container's center",
        "B": "Centers the element on the page",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "Prevents scroll chaining to parent containers",
    ...
    },
    {
      ...
      "options": {
        "A": "Using <pre>::-webkit-scrollbar</pre> and related pseudo-elements",
        "B": "<pre>scrollbar { background: blue; }</pre>",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "Yes, sticky elements stick within their scroll container",
        "D": "Only on mobile"
      },
      "correct": "C",
    ...
    },
    {
      ...
      "options": {
        ...
        "D": "Parent has <pre>overflow: hidden</pre> or the sticky element's container doesn't have enough height"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "No difference",
        "B": "<pre>scroll</pre> is faster",
        "C": "<pre>auto</pre> only shows scrollbars when needed; <pre>scroll</pre> always shows scrollbars (even if empty)",
    ...
    },
    {
      ...
      "options": {
        ...
        "D": "<pre>overflow-x: auto;</pre> (or scroll) with child elements that exceed container width"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "No standard property exists",
        "B": "<pre>scroll-color</pre>",
        "C": "<pre>bar-color</pre>",
        "D": "<pre>scrollbar-color</pre> with two color values (thumb and track)"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "<pre>scroll-display: none;</pre>",
        "C": "<pre>scrollbar-width: none;</pre> and <pre>::-webkit-scrollbar { display: none; }</pre>",
        "D": "It's impossible"
      },
      "correct": "C",
    ...
    },
    {
      ...
      "options": {
        "A": "Forces scroll to stop at this element rather than skipping it when scrolling past multiple snap points",
        "B": "Stops all scrolling",
    ...
    },
    {
      ...
      "options": {
        "A": "No, they conflict",
        "B": "Only on touch devices",
        "C": "Only with JavaScript",
        "D": "Yes, they work together to create smooth animated snapping"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "When scrolling an inner container reaches its limit and continues scrolling the outer container/page",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Hiding overflow",
        "C": "Allowing content to overflow and be visible outside the element's box (e.g., tooltips, dropdowns)",
    ...
    },
    {
      ...
      "options": {
        "A": "Container: <pre>scroll-snap-type: x mandatory; overflow-x: auto;</pre> Children: <pre>scroll-snap-align: center;</pre>",
