module.exports = {
    metadata: {
        title: "CSS Medium - Pseudo-elements and Advanced Pseudo-classes",
        ...
        topicLinks: [
            { "topicName": "Pseudo-elements", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/Pseudo-elements" },
            { "topicName": "::before and ::after", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/::before" },
            { "topicName": "::first-letter and ::first-line", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/::first-letter" },
            { "topicName": "::selection", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/::selection" },
            { "topicName": "::placeholder", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/::placeholder" },
            { "topicName": ":nth-child()", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/:nth-child" },
            { "topicName": ":nth-of-type()", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/:nth-of-type" },
            { "topicName": ":first-of-type and :last-of-type", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/:first-of-type" },
            { "topicName": ":only-child and :only-of-type", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/:only-child" },
            { "topicName": ":empty", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/:empty" },
            { "topicName": ":target", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/:target" }
        ],
        keywords: [
            "pseudo-element",
            "::before",
    ...
    questions: [
        ...
        },
        {
            ...
            options: {
                ...
                B: "Only font properties, color, and background",
                C: "Only width and height",
        ...
        },
        {
            ...
            options: {
                ...
                B: "Text highlighted by the user",
                C: "Radio button selections",
        ...
        },
        {
            ...
            options: {
                A: "You can only use color and background properties",
                B: "You can use all CSS properties",
                C: "Only font-size and font-weight work",
        ...
        },
        {
            ...
            options: {
                ...
                B: "<pre>:nth-child()</pre> counts all siblings; <pre>:nth-of-type()</pre> counts only siblings of the same element type",
                C: "<pre>:nth-of-type()</pre> is deprecated",
        ...
        },
        {
            ...
            options: {
                ...
                B: "The first element of its type among its siblings",
                C: "The first child element",
        ...
        },
        {
            ...
            options: {
                A: "Elements with a <pre>target</pre> attribute",
                B: "The element whose ID matches the current URL fragment identifier",
                C: "Link targets",
        ...
        },
        {
            ...
            options: {
                A: "By showing a hidden element when its ID is in the URL fragment",
                B: "By using JavaScript",
                C: "<pre>:target</pre> cannot be used for modals",
        ...
        },
        {
            ...
            options: {
                ...
                B: "No, only one pseudo-element per selector",
                C: "Yes, but only two",
                D: "Only with vendor prefixes"
            },
            correct: "B",
        ...
        },
        {
            ...
            options: {
                A: "They are identical; <pre>::before</pre> is the modern CSS3 syntax",
                B: "<pre>:before</pre> is deprecated",
        ...
        },
        {
            ...
            options: {
                A: "<pre>:nth-child(3n)</pre>",
                B: "<pre>:nth-child(3n+1)</pre>",
        ...
        },
        {
            ...
            options: {
                A: "Only text strings",
                B: "Text strings, attribute values, counters, and images",
                C: "Only images",
                D: "HTML elements"
            },
            correct: "B",
        ...
        },
        {
            ...
            options: {
                ...
                B: "<pre>::first-line</pre>",
                C: "<pre>::first-child</pre>",
                D: "<pre>::line-break</pre>"
            },
            correct: "B",
