  ...
  "questions": [
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Starts the animation from the beginning",
        "C": "Keeps the element at the final keyframe state after animation completes",
    ...
    },
    {
      ...
      "options": {
        "A": "Alternates between playing forward and backward on each iteration",
        "B": "Plays the animation in reverse only",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Increases element brightness",
        "C": "Moves the element 5px",
        "D": "Applies a Gaussian blur with a 5px radius to the element"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "Font blending",
        "D": "How an element's content blends with its background and elements behind it"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "Using counter-reset property on a parent element",
        "B": "Using counter-start property",
    ...
    },
    {
      ...
      "options": {
        ...
        "D": "To display the counter value in generated content"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "Creates 3 rows",
        "B": "Sets 3 grid columns",
        "C": "Divides the content into 3 newspaper-style columns",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Sets column width",
        "C": "Sets the spacing between columns",
    ...
    },
    {
      ...
      "options": {
        "A": "Maintains a 16:9 width-to-height ratio for the element",
        "B": "Sets width to 16px and height to 9px",
    ...
    },
    {
      ...
      "options": {
        "A": "linear-gradient transitions along a straight line, radial-gradient radiates from a center point",
        "B": "They are the same",
    ...
    },
    {
      ...
      "options": {
        "A": "Removes the browser's default styling, allowing custom styling",
        "B": "Hides the element",
    ...
    },
    {
      ...
      "options": {
        "A": "All form elements",
        "B": "Only checkboxes",
        "C": "Radio buttons, checkboxes, and option elements that are checked or selected",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Creates parallax effects",
        "C": "Sets scrollbar color",
        "D": "Controls what happens when scrolling reaches the boundary of a scroll container"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "Selects elements that do not match the selector inside the parentheses",
        "B": "Inverts colors",
        "C": "Hides elements",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": ":nth-child() is deprecated",
        "C": ":nth-of-type() is for classes only",
        "D": ":nth-of-type() selects by element type only, :nth-child() considers all children"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Resets the animation",
        "C": "Slows down the animation",
        "D": "Pauses the animation at its current position"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "backdrop-filter is faster",
        "C": "backdrop-filter applies effects to the area behind an element, filter applies to the element itself",
