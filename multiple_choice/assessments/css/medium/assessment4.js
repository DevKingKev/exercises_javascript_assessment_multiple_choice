module.exports = {
    "metadata": {
        ...
        "topicLinks": [
            {
                "topicName": "Attribute Selectors",
                "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/Attribute_selectors"
            },
            {
                "topicName": "Combinators",
                "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Selectors#combinators"
            },
            {
                "topicName": "Child Selector",
                "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/Child_combinator"
            },
            {
                "topicName": "Adjacent Sibling",
                "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/Adjacent_sibling_combinator"
            },
            {
                "topicName": "General Sibling",
                "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/General_sibling_combinator"
            },
            {
                "topicName": ":not()",
                "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/:not"
            },
            {
                "topicName": ":is() and :where()",
                "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/:is"
            },
            {
                "topicName": "Specificity",
                "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/Specificity"
            },
            {
                "topicName": "Complex Selector Chains",
                "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Selectors#complex_selectors"
            },
            {
                "topicName": "Selector Performance",
                "refLink": "https://developer.mozilla.org/en-US/docs/Web/Performance/Rendering_performance"
            }
        ],
        "keywords": [
            "attribute selector",
    ...
    "questions": [
        ...
        },
        {
            ...
            "options": {
                "A": "Only the <pre>p</pre> immediately following an <pre>h2</pre>",
                "B": "All <pre>p</pre> elements inside an <pre>h2</pre>",
                "C": "Every <pre>p</pre> that follows an <pre>h2</pre> anywhere later in the document",
                "D": "No elements"
            },
            "correct": "A",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": ":where() adds no specificity (specificity 0), :is() contributes normal specificity",
                "C": ":is() is slower",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "They have equal specificity",
                "C": "Specificity cannot be compared",
                "D": "<pre>.btn--disabled</pre>"
            },
            "correct": "B",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "The parent <pre>ul</pre>",
                "C": "The <pre>li</pre> immediately after a direct-child <pre>li.active</pre> inside the same <pre>ul</pre>",
                "D": "Any <pre>li</pre> after an <pre>li.active</pre> anywhere in the document"
            },
            "correct": "C",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "Class selectors",
                "C": "Universal selector (e.g., <pre>*</pre>) and deep descendant selectors (e.g., <pre>div span a</pre>)",
        ...
        },
        {
            ...
            "options": {
                "A": "<pre>input[name*=\"opt\"]</pre>",
                "B": "<pre>input[name$=\"opt\"]</pre>",
                "C": "<pre>input[type=\"checkbox\"][name^=\"opt\"]</pre>",
        ...
        },
        {
            ...
            "options": {
                "A": "Headings inside article",
                "B": "Any <pre>p</pre> inside article",
                "C": "A <pre>p</pre> immediately after any <pre>h2</pre> or <pre>h3</pre> inside an <pre>article</pre>",
                "D": "Only <pre>p</pre> not adjacent to headings"
            },
            "correct": "C",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "Only the first selector applies",
                "C": "It is invalid syntax",
                "D": "As separate selectors applied individually"
            },
            "correct": "D",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "It only matches the first selector",
                "C": "It's faster than :is()",
                "D": "It allows grouping selectors without increasing specificity (specificity 0)"
            },
            "correct": "D",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "Order doesn't matter if specificity differs",
                "C": "Always use !important instead",
                "D": "Place more specific selectors later"
            },
            "correct": "D",
