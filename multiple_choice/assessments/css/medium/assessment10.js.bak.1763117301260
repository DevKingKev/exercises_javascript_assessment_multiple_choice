module.exports = {
    metadata: {
        ...
        topicLinks: [
            { "topicName": "CSS Transforms", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/transform" },
            { "topicName": "translate()", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/transform-function/translate" },
            { "topicName": "rotate()", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/transform-function/rotate" },
            { "topicName": "scale()", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/transform-function/scale" },
            { "topicName": "skew()", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/transform-function/skew" },
            { "topicName": "transform-origin", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/transform-origin" },
            { "topicName": "perspective", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/perspective" },
            { "topicName": "transform-style", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/transform-style" },
            { "topicName": "3D Transforms", "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_transforms/Using_CSS_transforms#3d_specific_css_properties" }
        ],
        keywords: [
            "transform",
            "translate",
    ...
    questions: [
        ...
        },
        {
            ...
            options: {
                A: "Rotates element 45 degrees clockwise around its center",
                B: "Rotates element 45 degrees counterclockwise",
                C: "Tilts element 45 degrees",
                D: "Moves element 45 pixels"
            },
            correct: "A",
        ...
        },
        {
            ...
            options: {
                A: "Shrinks width to nothing",
                B: "Flips the element horizontally (mirror effect)",
                C: "Inverts colors",
        ...
        },
        {
            ...
            options: {
                A: "Skews element 20 degrees along X-axis and 10 degrees along Y-axis",
                B: "Rotates element",
                C: "Translates element",
                D: "Scales element"
            },
            correct: "A",
        ...
        },
        {
            ...
            options: {
                ...
                B: "Rotates element around its top-left corner instead of center",
                C: "Prevents rotation",
        ...
        },
        {
            ...
            options: {
                ...
                B: "List them space-separated in one transform property: <pre>transform: rotate(45deg) scale(1.5);</pre>",
                C: "Use commas: <pre>transform: rotate(45deg), scale(1.5);</pre>",
        ...
        },
        {
            ...
            options: {
                ...
                B: "Yes, different orders produce different visual results",
                C: "Only for 3D transforms",
        ...
        },
        {
            ...
            options: {
                A: "Rotates around the vertical Y-axis",
                B: "Rotates around the horizontal X-axis, flipping top-to-bottom in 3D space",
        ...
        },
        {
            ...
            options: {
                A: "Flips element horizontally in 3D space (back-face visible)",
        ...
        },
        {
            ...
            options: {
                ...
                B: "Sets the distance from the viewer to the 3D element, affecting depth perception",
                C: "Rotates elements",
                D: "Adjusts opacity"
            },
            correct: "B",
        ...
        },
        {
            ...
            options: {
                ...
                B: "Makes child elements participate in the parent's 3D space rather than being flattened",
                C: "Adds shadows",
        ...
        },
        {
            ...
            options: {
                ...
                B: "Yes, percentages are relative to the element's own dimensions",
        ...
        },
        {
            ...
            options: {
                ...
                B: "Scales element to zero size (invisible but still in layout)",
                C: "No effect",
        ...
        },
        {
            ...
            options: {
                ...
                B: "No, transforms are purely visual and don't affect layout or other elements",
                C: "Only 3D transforms affect layout",
        ...
        },
        {
            ...
            options: {
                A: "No difference",
                B: "Parent perspective creates shared vanishing point for all children; transform perspective is individual per element",
                C: "Parent version is deprecated",
                D: "Transform version doesn't work"
            },
            correct: "B",
