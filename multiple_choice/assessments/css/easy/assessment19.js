module.exports = {
  ...
  "questions": [
    ...
    },
    {
      ...
      "options": {
        "A": "Distributes items with equal space between them, first item at start, last item at end",
        "B": "Adds equal space between all items, including edges",
        "C": "Centers all items",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Always vertical",
        "C": "The longest axis",
        "D": "The axis defined by flex-direction"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "The axis perpendicular to the main axis",
        "B": "Always vertical",
        "C": "Always horizontal",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Centers items",
        "C": "Aligns items to the start of the main axis",
        "D": "Stretches items"
      },
      "correct": "C",
    ...
    },
    {
      ...
      "options": {
        "A": "Aligns items to the end of the cross axis",
        "B": "Aligns items to the start of the cross axis",
        "C": "Aligns items to the end of the main axis",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Only in modern browsers",
        "C": "Only if they have no parent",
        "D": "No, only direct children become flex items"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Flips the container upside down",
        "C": "Arranges items horizontally from right to left",
        "D": "Has no effect"
      },
      "correct": "C",
    ...
    },
    {
      ...
      "options": {
        "A": "Yes, using justify-content: space-between or space-around",
        "B": "No, flexbox can't do this",
    ...
    },
    {
      ...
      "options": {
        "A": "Aligns items so their text baselines align",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Creates multiple columns",
        "C": "Has no effect",
        "D": "Arranges items vertically from bottom to top"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Only in CSS Grid",
        "C": "Yes, by applying display: flex to the flex item",
    ...
    },
    {
      ...
      "options": {
        "A": "Centering items",
        "B": "Distributing space",
        "C": "Creating equal-height columns or cards",
    ...
    },
    {
      ...
      "options": {
        ...
        "C": "Centers items",
        "D": "Distributes items with equal space between items and at edges"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "Nothing changes",
        "B": "Only the main axis changes",
        "C": "They swap—what was main becomes cross and vice versa",
