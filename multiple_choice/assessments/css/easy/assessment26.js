module.exports = {
    "metadata": {
        ...
        "topicLinks": [
            {
                "topicName": "CSS Inheritance Basics",
                "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/Inheritance"
            },
            {
                "topicName": "Default Inherited Properties",
                "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/Inheritance#inherited_properties"
            },
            {
            ...
            {
                "topicName": "Unset Keyword",
                "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/unset"
            },
            {
                "topicName": "Inherited vs Non-inherited",
                "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/Inheritance"
            },
            {
                "topicName": "Text Property Inheritance",
                "refLink": "https://developer.mozilla.org/en-US/docs/Learn/CSS/Building_blocks/Cascade_and_inheritance"
            },
            {
                "topicName": "Box Model Inheritance",
                "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_box_model"
            },
            {
                "topicName": "Forcing Inheritance",
                "refLink": "https://developer.mozilla.org/en-US/docs/Web/CSS/inherit"
            },
            {
                "topicName": "Inheritance Best Practices",
                "refLink": "https://developer.mozilla.org/en-US/docs/Learn/CSS/Building_blocks/Cascade_and_inheritance#controlling_inheritance"
            }
        ],
        "keywords": [
            "inheritance",
    ...
    "questions": [
        {
            ...
            "options": {
                ...
                "B": "Using CSS frameworks",
                "C": "Child elements automatically receive certain property values from their parent elements",
        ...
        },
        {
            ...
            "options": {
                "A": "Forces the property to inherit the value from its parent element",
                "B": "Resets the property to its default value",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "Only on border properties",
                "C": "Yes, inherit forces any property to take the parent's value",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "Transparent",
                "C": "White",
                "D": "The browser's default (typically black, but depends on the browser)"
            },
            "correct": "D",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "Removes the property entirely",
                "C": "Acts like inherit for inherited properties, and initial for non-inherited properties",
        ...
        },
        {
            ...
            "options": {
                "A": "No, padding does not inherit by default",
                "B": "Yes, padding inherits from parent",
        ...
        },
        {
            ...
            "options": {
                "A": "No, it must be set on every element",
                "B": "Only for paragraphs",
                "C": "Yes, line-height inherits from the parent",
        ...
        },
        {
            ...
            "options": {
                "A": "No, border does not inherit by default",
                "B": "Yes, borders inherit from parent elements",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "Inherited is always transparent",
                "C": "Transparent shows the parent's background through, inherited copies the parent's background-color value",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "Only when using em units",
                "C": "Only for text elements",
                "D": "Yes, font-size inherits from the parent"
            },
            "correct": "D",
        ...
        },
        {
            ...
            "options": {
                "A": "No, width does not inherit by default",
                "B": "Yes, width inherits from parent",
                "C": "Only for block elements",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "Only when using percentages",
                "C": "Only for inline elements",
                "D": "No, height does not inherit by default"
            },
            "correct": "D",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "It uses the default padding",
                "C": "The padding is removed",
                "D": "The element's padding becomes the same as its parent's padding"
            },
            "correct": "D",
        ...
        },
        {
            ...
            "options": {
                "A": "Yes, but it's special - the decoration appears on descendants",
                "B": "No, it doesn't inherit",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "Only hidden values inherit",
                "C": "Yes, visibility inherits from the parent",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "Removing borders",
                "C": "Making child elements have the same border as their parent",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "Only the bullet style inherits",
                "C": "Only for ul elements",
                "D": "Yes, list-style inherits from the parent"
            },
            "correct": "D",
        ...
        },
        {
            ...
            "options": {
                "A": "All properties are reset to their CSS specification defaults",
                "B": "Only inherited properties are reset",
