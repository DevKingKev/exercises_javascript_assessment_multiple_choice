/**
 * CSS Easy Level Assessment 9
 * Topic: Box Model Fundamentals
 * 
...
module.exports = {
    ...
    "questions": [
        ...
        },
        {
            ...
            "options": {
                "A": "They add together",
                "B": "They collapse to the larger margin",
                "C": "They cancel out",
                "D": "They create a gap between elements"
            },
            "correct": "B",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "Set border-radius to 50%",
                "C": "Set border-radius to circle",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "border-box includes padding/border in width; content-box doesn't",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "10px all, 20px top, 30px bottom",
        ...
        },
        {
            ...
            "options": {
                ...
                "D": "Padding is for text only; margin is for boxes"
            },
            "correct": "A",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "Centers a block element horizontally",
        ...
        },
        {
            ...
            "options": {
                "A": "Yes, always",
                "B": "No, only vertical margins collapse",
                "C": "Only in flexbox",
                "D": "Only in grid"
            },
            "correct": "B",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "Removes the border completely",
                "C": "Sets border width to 0",
                "D": "Makes border invisible but keeps space"
            },
            "correct": "B",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "Yes, using four values or individual properties",
                "C": "Only two corners can differ",
                "D": "Only in CSS3"
            },
            "correct": "B",
        ...
        },
        {
            ...
            "options": {
                "A": "Sets width to 100%",
                "B": "Lets the browser calculate the width based on content and context",
                "C": "Sets width to 0",
                "D": "Makes the element disappear"
            },
            "correct": "B",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "Yes, negative margins pull elements closer or cause overlap",
        ...
        {
            "id": 21,
            "question": "With <pre>box-sizing: border-box;</pre> and <pre>width: 200px; padding: 20px; border: 10px;</pre>, what is the total width?",
            "options": {
                "A": "200px",
                "B": "240px",
                "C": "260px",
        ...
        },
        {
            ...
            "options": {
                "A": "They add together",
                "B": "The larger margin collapses through and appears outside the parent",
                "C": "Only the parent's margin applies",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "<pre>border-bottom: 1px solid black;</pre>",
                "C": "<pre>border: 1px solid bottom;</pre>",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "Yes, background extends into the padding area",
                "C": "Only if background-clip is set",
                "D": "Only for background images"
            },
            "correct": "B",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "The parent element must have a defined height",
                "C": "The element must be position: absolute",
                "D": "It only works in flexbox"
            },
            "correct": "B",
        ...
        },
        {
            ...
            "options": {
                "A": "10px top, 20px right, 30px bottom, 40px left",
                "B": "10px left, 20px top, 30px right, 40px bottom",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "Yes, percentages are relative to element dimensions",
                "C": "Only for circles",
