    ...
    "questions": [
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "Outline doesn't take up space in the layout (doesn't affect box model)",
                "C": "Border can't be styled",
                "D": "Outline is always visible"
            },
            "correct": "B",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "Yes, using border-top-style, border-right-style, etc.",
        ...
        },
        {
            ...
            "options": {
                "A": "border-color",
                "B": "border-width",
                "C": "border-style (to something other than 'none')",
                "D": "All three must be set"
            },
            "correct": "C",
        ...
        },
        {
            ...
            "options": {
                "A": "Top/bottom get 5px, left/right get 10px",
        ...
        },
        {
            ...
            "options": {
                "A": "No, all sides must be the same color",
                "B": "Yes, using border-top-color, border-right-color, etc.",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "For focus indicators on interactive elements",
                "C": "For layouts",
                "D": "For rounded corners"
            },
            "correct": "B",
        ...
        },
        {
            ...
            "options": {
                "A": "Yes, in all browsers",
                "B": "Yes, but only in modern browsers with outline following border-radius",
        ...
        },
        {
            ...
            "options": {
                "A": "Black",
                "B": "Transparent",
                "C": "The element's text color (currentColor)",
                "D": "White"
            },
            "correct": "C",
        ...
        },
        {
            ...
            "options": {
                "A": "Top-left/bottom-right: 10px, top-right/bottom-left: 20px",
                "B": "All corners: 10px",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "Yes, negative values draw the outline inside the element",
                "C": "Only in Firefox",
        ...
        },
        {
            ...
            "options": {
                "A": "Any order: width, style, and color can be in any sequence",
                "B": "Must be: width, color, style",
                "C": "Must be: style, width, color",
        ...
        },
        {
            ...
            "options": {
                "A": "Yes, using outline-top, outline-right, etc.",
                "B": "No, outline applies to all four sides equally",
                "C": "Only in CSS Grid",
        ...
        },
        {
            ...
            "options": {
                "A": "It's impossible",
                "B": "Use two values separated by a slash: border-radius: 50px / 25px;",
                "C": "Use border-ellipse",
        ...
        },
        {
            ...
            "options": {
                "A": "When you need different styling on each side",
        ...
        },
        {
            ...
            "options": {
                "A": "All sides solid",
                "B": "Top/bottom solid, left/right dashed",
        ...
        },
        {
            ...
            "options": {
                "A": "Yes, using outline-top-width, etc.",
                "B": "No, outline-width applies equally to all sides",
