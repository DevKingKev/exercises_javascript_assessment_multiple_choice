module.exports = {
    ...
    "questions": [
        ...
        },
        {
            ...
            "options": {
                "A": "<pre>list-style-type: none;</pre>",
                "B": "<pre>bullets: hidden;</pre>",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "Merges adjacent cell borders into a single border",
                "C": "Adds spacing between cells",
        ...
        },
        {
            ...
            "options": {
                "A": "<pre>disc</pre>, <pre>circle</pre>, <pre>square</pre>, <pre>none</pre>",
                "B": "Only <pre>disc</pre> and <pre>circle</pre>",
                "C": "Only <pre>decimal</pre> and <pre>alpha</pre>",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "No, border-spacing is ignored when borders are collapsed",
                "C": "Only with positive values",
                "D": "Only on the first row"
            },
            "correct": "B",
        ...
        },
        {
            ...
            "options": {
                "A": "<pre>list</pre>",
                "B": "<pre>list-style</pre>",
                "C": "<pre>ul-style</pre>",
                "D": "<pre>list-properties</pre>"
            },
            "correct": "B",
        ...
        },
        {
            ...
            "options": {
                "A": "Prevents the table from scrolling",
                "B": "Makes table column widths depend only on the first row and table width, not content",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "Every odd-numbered element (1st, 3rd, 5th, etc.)",
                "C": "Every even-numbered element",
        ...
        },
        {
            ...
            "options": {
                "A": "[CODE]list-style: none; margin: 0; padding: 0;[/CODE]",
                "B": "<pre>display: none;</pre>",
                "C": "<pre>list-reset: true;</pre>",
                "D": "<pre>bullets: hidden;</pre>"
            },
            "correct": "A",
        ...
        },
        {
            ...
            "options": {
                "A": "Only <pre><td></pre> elements",
                "B": "Only <pre><tr></pre> elements",
                "C": "Only <pre><table></pre> elements",
        ...
        },
        {
            ...
            "options": {
                "A": "Every third row (3rd, 6th, 9th, etc.)",
                "B": "Only the third row",
                "C": "The first three rows",
                "D": "Every third element regardless of type"
            },
            "correct": "A",
        ...
        },
        {
            ...
            "options": {
                "A": "Yes, padding works normally on table cells",
                "B": "No, table cells don't support padding",
        ...
        },
        {
            ...
            "options": {
                "A": "<pre>border-spacing: 5px 10px;</pre> (horizontal then vertical)",
                "B": "<pre>border-spacing-x: 5px; border-spacing-y: 10px;</pre>",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "Yes, using <pre>list-style-image: linear-gradient(...);</pre>",
                "C": "Only with radial gradients",
                "D": "Only in Chrome"
            },
            "correct": "B",
        ...
        },
        {
            ...
            "options": {
                "A": "Yes, text-align works on <pre><td></pre> and <pre><th></pre> elements",
        ...
        },
        {
            ...
            "options": {
                "A": "[CODE]tr:nth-child(even) { background: gray; }[/CODE]",
                "B": "[CODE]tr:nth-child(odd) { background: gray; }[/CODE]",
                "C": "[CODE]tr:first { background: white; }[/CODE]",
                "D": "[CODE]tr { background: alternating(white, gray); }[/CODE]"
            },
            "correct": "A",
        ...
        },
        {
            ...
            "options": {
                "A": "Yes, margin works like on any other element",
                "B": "No, table cells don't support margin",
