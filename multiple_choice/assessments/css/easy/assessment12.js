    ...
    "questions": [
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "The element stays in the flow but can be offset from its normal position",
                "C": "The element is positioned relative to the viewport",
                "D": "The element becomes a block element"
            },
            "correct": "B",
        ...
        },
        {
            ...
            "options": {
                "A": "The nearest positioned ancestor (position other than static)",
                "B": "Always the <pre><body></pre> element",
                "C": "Always the viewport",
                "D": "Its immediate parent element"
            },
            "correct": "A",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "No, z-index only works on positioned elements",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "The space collapses and other elements move up to fill it",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "<pre>padding-top</pre>, <pre>padding-left</pre>",
                "C": "<pre>top</pre>, <pre>right</pre>, <pre>bottom</pre>, <pre>left</pre>",
        ...
        },
        {
            ...
            "options": {
                "A": "To create fixed headers",
                "B": "To establish a positioning context for absolutely positioned children",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "Yes, and they work together to stretch the element",
                "C": "Only on absolutely positioned elements",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "No, the element appears in its normal position",
                "C": "Yes, it adds spacing around the element",
                "D": "Yes, it removes the element from the flow"
            },
            "correct": "B",
        ...
        },
        {
            ...
            "options": {
                ...
                "C": "To establish a positioning reference for absolutely positioned children",
                "D": "To increase the parent's z-index"
            },
            "correct": "C",
        ...
        },
        {
            ...
            "options": {
                ...
                "C": "Bottom-right corner of its positioned parent",
                "D": "Top-right corner of its positioned parent"
            },
            "correct": "D",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "Yes, other elements behave as if it doesn't exist",
        ...
        },
        {
            ...
            "options": {
                "A": "The element won't render",
                "B": "The element positions relative to the initial containing block (document)",
        ...
        },
        {
            ...
            "options": {
                "A": "Yes, that's a common use case for fine-tuning layout",
                "B": "No, relative positioning doesn't support offsets",
                "C": "Only if the element is inline",
        ...
        },
        {
            ...
            "options": {
                "A": "A way to stack divs vertically",
                "B": "A 3D rendering space where z-index determines order within that context",
        ...
        },
        {
            ...
            "options": {
                "A": "At the center of the viewport",
                "B": "At 50% from the left edge of its positioned parent",
