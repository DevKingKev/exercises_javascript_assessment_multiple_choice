  ...
  "questions": [
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Makes the item invisible",
        "C": "Prevents the item from shrinking below its size",
    ...
    },
    {
      ...
      "options": {
        ...
        "D": "Allows flex items to wrap to multiple lines"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Aligns the container itself",
        "C": "Allows an individual flex item to override align-items",
    ...
    },
    {
      ...
      "options": {
        ...
        "D": "The initial/ideal size of a flex item before growing or shrinking"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Changes flex-direction",
        "C": "Removes items",
        "D": "Adds spacing between flex items"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "Moves the item to appear first visually (before items with order: 0)",
        "B": "Hides the item",
        "C": "Deletes the item",
        "D": "Reverses the item"
      },
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Text alignment inside items",
        "C": "Alignment of flex lines in a multi-line flex container",
    ...
    },
    {
      ...
      "options": {
        "A": "Prevents wrapping",
        "B": "Same as flex-wrap: wrap",
        "C": "Reverses item order on one line",
        "D": "Wraps items to multiple lines in reverse order"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "Yes, gap is often cleaner because it doesn't add space at container edges",
        "B": "No, only margins work",
        "C": "Only in CSS Grid",
    ...
    },
    {
      ...
      "options": {
        "A": "Only when flex-wrap allows multiple lines and there's extra space on cross axis",
        "B": "Always",
    ...
    },
    {
      ...
      "options": {
        "A": "flex: 1 1 auto; (can grow and shrink based on content size)",
        "B": "flex: 0 1 auto; (default flex values)",
        "C": "flex: 0 0 auto;",
        "D": "No flex behavior"
      },
      "correct": "A",
    ...
    },
    {
      ...
      "options": {
        "A": "Yes, you can change visual order responsively with media queries",
        "B": "No, order is fixed",
    ...
    },
    {
      ...
      "options": {
        ...
        "D": "Preventing images or buttons from becoming too small"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Prevents items from growing",
        "C": "Has no effect",
        "D": "Makes items distribute space equally ignoring content size"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Makes it wider",
        "C": "Stretches it to fill the container height (or width on cross axis)",
        "D": "Has no effect"
      },
      "correct": "C",
    ...
    },
    {
      ...
      "options": {
        "A": "display: flex; flex-wrap: wrap; gap: 20px; on container, flex: 1 1 300px; on items",
        "B": "display: flex; on container only",
        "C": "display: grid; only",
