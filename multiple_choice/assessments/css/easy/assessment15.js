  ...
  "questions": [
    {
      ...
      "options": {
        "A": "Applies styles when the mouse pointer is over the element",
        "B": "Applies styles when the element is clicked",
    ...
    },
    {
      ...
      "options": {
        "A": "An element that has been visited",
        "B": "An element that is always visible",
        "C": "An element with keyboard focus",
        "D": "An element that is currently being activated or clicked"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Styling hidden elements",
        "C": "Styling only links",
        "D": "Styling elements that have received keyboard or mouse focus"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "HALV: :hover, :active, :link, :visited",
        "B": "LVHA: :link, :visited, :hover, :active",
    ...
    },
    {
      ...
      "options": {
        "A": "Links that the user has already visited",
        "B": "All elements that have been clicked",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": ":link targets unvisited links; :visited targets links the user has visited",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Only on block elements",
        "C": "Only on buttons and links",
        "D": "Yes, :hover can be used on any element"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "An element that is the last child of its parent",
    ...
    },
    {
      ...
      "options": {
        "A": "It provides visual feedback for keyboard navigation users",
        "B": "It makes pages load faster",
    ...
    },
    {
      ...
      "options": {
        "A": "Yes, :active works on buttons to show click state",
        "B": "No, only on links",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "The browser shows an error",
        "C": "The :link styles may override :hover due to equal specificity and source order",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "<pre>:every-third</pre>",
        "C": "<pre>:nth-child(3n)</pre>",
    ...
    },
    {
      ...
      "options": {
        "A": "Only color, background-color, and related color properties",
        "B": "All CSS properties",
    ...
    },
    {
      ...
      "options": {
        "A": "<pre>div:first-child p</pre>",
        "B": "<pre>div p:first-child</pre>",
        "C": "<pre>p:first</pre>",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "Only if the div has content",
        "C": "No, only interactive elements like inputs, buttons, and links can receive focus by default",
    ...
    },
    {
      ...
      "options": {
        ...
        "B": "<pre>display: none;</pre> on focus",
        "C": "You should never remove the focus outline",
        "D": "[CODE]:focus { outline: none; /* provide alternative styling */ }[/CODE]"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "Only links with an href attribute",
        "B": "All <pre><a></pre> elements",
    ...
    },
    {
      ...
      "options": {
        "A": "No, dropdown menus require JavaScript",
        "B": "Yes, by showing hidden child elements on parent hover",
    ...
    },
    {
      ...
      "options": {
        "A": "The <pre><li></pre> containing 'C'",
        "B": "All <pre><li></pre> elements",
        "C": "The first <pre><li></pre>",
        "D": "Nothing"
      },
      "correct": "A",
    ...
    },
    {
      ...
      "options": {
        "A": "Because :active is more important",
        "B": "It's just a convention with no technical reason",
        "C": "To make the CSS file smaller",
        "D": "To ensure the active state shows during clicks even when hovering"
      },
      "correct": "D",
    ...
    },
    {
      ...
      "options": {
        "A": "No, negative numbers are invalid",
        "B": "Yes, for example <pre>:nth-child(-n+3)</pre> selects the first 3 children",
    ...
    },
    {
      ...
      "options": {
        "A": "The input disappears",
        "B": "The input becomes larger",
        "C": "The input changes color",
        "D": "A colored outline or border around the input"
      },
      "correct": "D",
