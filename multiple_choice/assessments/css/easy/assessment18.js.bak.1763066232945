    ...
    "questions": [
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "Clips content that exceeds the container, hiding the overflow",
                "C": "Adds scrollbars",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "Hides all overflow",
                "C": "Adds scrollbars only when content overflows",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "white-space: nowrap; and overflow: hidden;",
                "C": "Only overflow: hidden;",
                "D": "Only width property"
            },
            "correct": "B",
        ...
        },
        {
            ...
            "options": {
                "A": "Removes all white space from text",
                "B": "Prevents text from wrapping to a new line",
        ...
        },
        {
            ...
            "options": {
                "A": "When you want scrollbars only when needed",
                "B": "When you always want scrollbars visible",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "Adds scrollbars",
                "C": "Content overflows and is visible outside the container boundaries",
                "D": "Compresses the content to fit"
            },
            "correct": "C",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "No, it only hides it visually; the content still exists in the DOM",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "Clearing floats or containing floated children",
                "C": "Making elements invisible",
                "D": "Adding margins"
            },
            "correct": "B",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "Doesn't affect horizontal overflow (horizontal overflow remains visible by default)",
                "C": "Adds horizontal scrollbar",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "Text stays on one line and may overflow the container visibly",
        ...
        },
        {
            ...
            "options": {
                "A": "Yes, it works on any container",
                "B": "No, text-overflow only applies to the text content of the element itself, not descendants",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "No, you can still scroll programmatically with JavaScript",
                "C": "Only prevents vertical scrolling",
                "D": "Only prevents horizontal scrolling"
            },
            "correct": "B",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "overflow: hidden clips overflow content; visibility: hidden hides the entire element but reserves its space",
                "C": "overflow: hidden hides the element; visibility: hidden clips content",
                "D": "No difference in modern browsers"
            },
            "correct": "B",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "Yes, it adds a horizontal scrollbar when content is wider than the container",
                "C": "Only with overflow-y: hidden",
                "D": "Only for images"
            },
            "correct": "B",
        ...
        },
        {
            ...
            "options": {
                ...
                "B": "auto hides scrollbars until user scrolls; scroll may show scrollbar tracks",
                "C": "auto doesn't work on mobile",
                "D": "scroll is faster"
            },
            "correct": "B",
        ...
        },
        {
            ...
            "options": {
                "A": "Nothing special, spans work automatically",
                "B": "The span must be display: block or inline-block, plus overflow, white-space, and text-overflow",
        ...
        },
        {
            ...
            "options": {
                "A": "To allow vertical scrolling while preventing horizontal overflow",
                "B": "To allow horizontal scrolling only",
                "C": "To hide all content",
                "D": "To make content wrap"
            },
            "correct": "A",
