module.exports = {
  metadata: {
    ...
    questionCount: 30,
    assessmentId: 22,
    assessmentUniqueId: 1731530400000,
  ...
  questions: [
    ...
    },
    {
      ...
      options: {
        ...
        B: "An empty grid cell",
        C: "A margin between cells",
    ...
    },
    {
      ...
      options: {
        A: "Increases the gap between items",
        B: "Makes grid items smaller",
    ...
    },
    {
      ...
      options: {
        ...
        B: "Align a single grid item horizontally within its grid area",
        C: "Align the entire grid container",
        D: "Justify text content within a grid item"
      },
      correct: "B",
    ...
    },
    {
      ...
      options: {
        ...
        B: "Yes, it changes the visual order of grid items",
        C: "Only with grid-auto-flow: column",
        D: "Only in combination with grid-area"
      },
      correct: "B",
    ...
    },
    {
      ...
      options: {
        A: "The number of columns to create automatically",
        B: "The width of implicitly created columns",
    ...
    },
    {
      ...
      options: {
        ...
        B: "Yes, by repeating the area name across cells",
        C: "Only across columns, not rows",
    ...
    },
    {
      ...
      options: {
        ...
        B: "row-start / column-start / row-end / column-end",
        C: "top / right / bottom / left",
        D: "start-row / start-column / end-row / end-column"
      },
      correct: "B",
    ...
    },
    {
      ...
      options: {
        A: "Aligns items to the start of their grid areas",
        B: "Aligns the entire grid to the top of the container",
    ...
    },
    {
      ...
      options: {
        ...
        B: "Explicit is defined with grid-template-*, implicit is auto-created",
    ...
    },
    {
      ...
      options: {
        A: "No, names must be unique",
        B: "Yes, and you can target them using [name n] syntax",
    ...
    },
    {
      ...
      options: {
        ...
        B: "Flows items row-by-row and fills holes with later items",
        C: "Makes rows automatically resize",
    ...
    },
    {
      ...
      options: {
        ...
        B: "Yes, all rows must have equal cells to form a rectangle",
        C: "Only if using named areas",
        D: "Only when grid-auto-flow is set to row"
      },
      correct: "B",
